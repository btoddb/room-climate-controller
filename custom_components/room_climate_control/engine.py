...
executes the returned commands. Keeping it pure makes the 1100-line blueprint
port unit-testable with plain ``python3``.

Ported from ``blueprints/automation/btoddb/room_climate_control.yaml``.
"""
...
class EngineInputs:
    ...
    def ac_setpoint_int(self) -> int:
        ...
        return round(max(min_temp if min_temp is not None else 65, 65))
