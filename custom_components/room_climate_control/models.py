...
Pure logic ported from the legacy ``scripts/daily_climate_lib.py`` and
``scripts/daily_climate_profile_presets.py`` so it can be unit-tested and reused
across the config flow, websocket API, scheduler, and entity platforms.
"""
