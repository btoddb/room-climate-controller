...
from .entity import resolve_profile_entity, resolve_room_entity
...
# Read commands
# ---------------------------------------------------------------------------
@websocket_api.websocket_command({vol.Required("type"): "room_climate/rooms/list"})
@callback
def ws_list_rooms(
    hass: HomeAssistant, connection: websocket_api.ActiveConnection, msg: dict
) -> None:
...
@websocket_api.websocket_command({vol.Required("type"): "room_climate/profiles/list"})
@callback
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "room_climate/profiles/create",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "room_climate/profiles/delete",
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "room_climate/profiles/rename",
        vol.Required("profile_id"): str,
        vol.Required("name"): str,
    }
)
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "room_climate/profiles/set_room",
        vol.Required("profile_id"): str,
        vol.Required("room"): str,
    }
)
...
@websocket_api.websocket_command(
    {
        vol.Required("type"): "room_climate/profiles/apply",
        vol.Required("profile_id"): str,
    }
)
@websocket_api.async_response
