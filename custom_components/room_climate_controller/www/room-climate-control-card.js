    ...
    <div class="settings-row">
      ...
      <div class="settings-row-control settings-slider-control">
        <input
          ...
          step=${a}
          .value=${String(l)}
          @input=${i => { const s = parseFloat(i.target.value); Number.isNaN(s) || Ce(e, t, s) }}
        />
        <span class="settings-offset-value">${l}°F</span>
      </div>
    </div>
  `} function Ne(e, t, i) {
  const s = Boolean(t.subtractOffsets), o = Se(e, t.target, t.mediumOffset, s), r = Se(e, t.target, t.highOffset, s); return L`
    <div class="settings-section">
      <div class="settings-section-title">${t.title}</div>
      ${function (e, t, i) {
      const s = ke(e, t); if (!s) return K; const o = Number(s.attributes.min ?? 0), r = Number(s.attributes.max ?? 100), n = Number(s.attributes.step ?? 1), a = Ee(e, t); return L`
    <div class="settings-row">
      <span class="settings-row-label">${i}</span>
      <div class="settings-row-control settings-target-control">
        <input
          ...
          step=${n}
          .value=${String(a)}
          @change=${i => { const s = parseFloat(i.target.value); Number.isNaN(s) || Ce(e, t, s) }}
        />
...
`; function Te(e) { return e.callWS({ type: "room_climate_controller/rooms/list" }) } function Re(e) { return e.callWS({ type: "room_climate_controller/profiles/list" }) } let Me = [], De = [], He = !1, Ue = null; const ze = new Set; function Be(e) { return ze.add(e), () => ze.delete(e) } async function je(e) { return Ue || (Ue = (async () => { try { const [t, i] = await Promise.all([Te(e), Re(e)]); Me = t.rooms ?? [], De = i.profiles ?? [], He = !0, function () { for (const e of ze) e() }() } catch { } finally { Ue = null } })(), Ue) } function Le() { return Me } function Ge(e) { return Me.find(t => t.key === e) } function Ke() { return Me.map(e => ({ key: e.key, label: e.label, has_heating: e.has_heating, has_fan: e.has_fan })) } function We(e) { const t = e.entities.presets ?? {}, i = { name: Ge(e.room)?.label ?? e.room, roomKey: e.room, has_heating: e.has_heating, has_fan: e.has_fan, useCooling: t.cooling?.use_entity ?? void 0, useHeating: t.heating?.use_entity ?? void 0, useFan: t.fan?.use_entity ?? void 0, fanOverride: e.entities.fan_override ?? void 0, cooling: t.cooling?.temp_entity ?? "", heating: t.heating?.temp_entity ?? void 0, fan: t.fan?.temp_entity ?? void 0 }; return { profileId: e.id, name: e.name, enabled: e.entities.enabled ?? "", time: e.entities.time ?? "", roomKey: e.room, room: i } } function qe(e) { return De.filter(t => t.room === e).map(We).sort((e, t) => { const i = Ve(e.profileId), s = Ve(t.profileId); return i !== s ? i.localeCompare(s) : e.profileId.localeCompare(t.profileId, void 0, { numeric: !0 }) }) } function Ve(e) { return De.find(t => t.id === e)?.time ?? "99:99" } const Je = { use: null, target: null, medium_offset: null, high_offset: null }; function Ze(e) { return e.room?.trim() || e.profile_room_key?.trim() || void 0 } function Ye(e) { const t = Ze(e); if (!t) return; const i = Ge(t); if (!i) return; const s = i.entities, o = e => s.live[e] ?? Je, r = o("cooling"), n = o("heating"), a = o("fan"); return function (e = {}) { return { type: "custom:room-climate-control", room_name: "Room", temp_sensor: "", use_ac: "", use_heater: "", use_fan: "", manual_mode: "", target_cooling: "", cooling_medium_offset: "", cooling_high_offset: "", target_heating: "", heating_medium_offset: "", heating_high_offset: "", target_fan: "", fan_medium_offset: "", fan_high_offset: "", outdoor_sensor: fe, time_range: "", ...e } }({ type: "custom:room-climate-control", room: t, profile_room_key: t, room_name: i.label, temp_sensor: s.temperature ?? "", humidity_sensor: s.humidity ?? "", power_sensor: s.power ?? "", ac_entity: s.ac_entity ?? "", heater_entity: s.heater_entity ?? "", fan_entity: s.fan_entity ?? "", manual_mode: s.manual_mode ?? "", ac_fan_only_override: s.ac_fan_only_override ?? "", heater_fan_only_override: s.heater_fan_only_override ?? "", use_ac: r.use ?? "", target_cooling: r.target ?? "", cooling_medium_offset: r.medium_offset ?? "", cooling_high_offset: r.high_offset ?? "", use_heater: n.use ?? "", target_heating: n.target ?? "", heating_medium_offset: n.medium_offset ?? "", heating_high_offset: n.high_offset ?? "", use_fan: a.use ?? "", target_fan: a.target ?? "", fan_medium_offset: a.medium_offset ?? "", fan_high_offset: a.high_offset ?? "", outdoor_sensor: e.outdoor_sensor ?? s.outdoor ?? fe, time_range: e.time_range ?? s.time_range ?? "", ac_device_button: s.ac_device_button ?? e.ac_device_button, heater_device_button: s.heater_device_button ?? e.heater_device_button, fan_device_button: s.fan_device_button ?? e.fan_device_button }) } let Qe = class extends ae {
  constructor() { super(...arguments), this._settingsOpen = !1, this._graphDialog = null, this._graphOverlay = new Fe } setConfig(e) { if (this._userConfig = e, !Ze(e)) return this._config = void 0, void (this._configError = "Select a room in the card editor."); this._configError = void 0, this._resolveRoom() } _resolveRoom() { const e = Ye(this._userConfig); if (e) return this._config = e, void (this._configError = void 0); const t = Ze(this._userConfig); Le().length > 0 && t && !function (e) { return Le().some(t => t.key === e) }(t) && (this._config = void 0, this._configError = `Unknown room "${t}". Add it in the Room Climate integration.`) } getCardSize() { return 6 } static getConfigElement() { return document.createElement("room-climate-control-editor") } static getStubConfig() { const e = Le()[0]?.key; return { type: "custom:room-climate-control", room: e ?? "" } } connectedCallback() { super.connectedCallback(), je(this.hass), this._unsubRooms ??= Be(() => { this._resolveRoom(), this.requestUpdate() }) } disconnectedCallback() { super.disconnectedCallback(), this._graphOverlay.close(), this._unsubRooms?.(), this._unsubRooms = void 0 } updated(e) { if (!(e.has("hass") && this._graphDialog && this.hass && this._config)) return; this._overlayGraphEl && (this._overlayGraphEl.hass = this.hass), this._overlayPowerNowEl && _e(this._config.power_sensor) && (this._overlayPowerNowEl.textContent = ve(this.hass, this._config.power_sensor)); const t = this._config.time_range || "", i = this.hass.states[t]?.state; i && i !== this._lastGraphHours && (this._lastGraphHours = i, this._mountGraphOverlay()) } render() {
    ...
    `} _renderProfilesPanel(e) {
    const t = function (e) { const t = e.profile_room_key?.trim(); if (t) return t; const i = e.manual_mode?.trim(); if (i) { const e = Le().find(e => e.entities.manual_mode === i); if (e) return e.key } const s = e.manual_mode?.match(/^input_boolean\.([a-z0-9_]+)_climate_manual_mode$/); return s && Le().some(e => e.key === s[1]) ? s[1] : void 0 }(e); return t ? L`
      ...
      ></room-climate-profiles-panel>
    `: K
  } _renderDevicesPanel(e) {
    const t = [], i = (e, i, s, o, r, n) => {
      if (!_e(i) || !function (e, t) { if (!_e(t)) return !1; const i = e.states[t]; return !!i && "unavailable" !== i.state && "unknown" !== i.state }(this.hass, i)) return; const a = ke(this.hass, s); if (!a) return; const l = i, c = function (e, t, i = 72) { const s = e.states[t]; if (!s) return i; const o = parseFloat(s.state); return Number.isNaN(o) ? i : Math.round(o) }(this.hass, o), d = r(this.hass, l), h = _e(n), p = h ? ke(this.hass, n) : void 0; t.push(L`
      ...
      `), L`<div class="devices-section">${t}</div>`
  } _renderSettingsDialog() {
    if (!this._config) return K; const e = function (e) { const t = []; return _e(e.ac_entity) && t.push({ title: "Cooling", target: e.target_cooling, mediumOffset: e.cooling_medium_offset, highOffset: e.cooling_high_offset, deviceButton: e.ac_device_button }), _e(e.heater_entity) && t.push({ title: "Heating", target: e.target_heating, mediumOffset: e.heating_medium_offset, highOffset: e.heating_high_offset, subtractOffsets: !0, deviceButton: e.heater_device_button }), _e(e.fan_entity) && t.push({ title: "Fan", target: e.target_fan, mediumOffset: e.fan_medium_offset, highOffset: e.fan_high_offset, deviceButton: e.fan_device_button }), t }(this._config); return L`
      <ha-dialog
        open
      ...
      >
        <div class="dialog-body">
          ${function (e, t) {
        const i = []; return _e(t.temp_sensor) && i.push(L`
  ...
  constructor() { super(...arguments), this._schemaKey = "", this._computeLabel = e => Xe[e.name] || e.name } setConfig(e) { this._config = { ...e, type: "custom:room-climate-control" } } connectedCallback() { super.connectedCallback(), this.hass && je(this.hass), this._unsub ??= Be(() => this.requestUpdate()) } disconnectedCallback() { super.disconnectedCallback(), this._unsub?.(), this._unsub = void 0 } _getSchema(e) { const t = e.map(e => e.key).join(","); return this._schema && t === this._schemaKey || (this._schema = function (e) { return [{ name: "room", required: !0, selector: { select: { mode: "dropdown", options: e.map(e => ({ value: e.key, label: e.label })) } } }, ...tt] }(e), this._schemaKey = t), this._schema } render() {
    if (!this.hass || !this._config) return L``; const e = Ke(), t = Ge(this._config.room ?? "")?.entities, i = function (e, t = {}) { return { room: e.room ?? "", outdoor_sensor: e.outdoor_sensor ?? t.outdoor_sensor ?? "", time_range: e.time_range ?? t.time_range ?? "" } }(this._config, { outdoor_sensor: t?.outdoor, time_range: t?.time_range }); return L`
      ...
      ></ha-form>
    `} _valueChanged(e) { e.stopPropagation(); const t = e.detail.value, i = { ...this._config, ...t, type: "custom:room-climate-control" }, s = i; for (const e of et) { const t = s[e]; (null == t || "" === t || "object" == typeof t && 0 === Object.keys(t).length) && delete s[e] } var o, r; this._config = i, o = this, r = this._config, o.dispatchEvent(new CustomEvent("config-changed", { bubbles: !0, composed: !0, detail: { config: r } })) } static get styles() {
    return n`
      :host {
        display: block;
        padding: 16px;
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let _t = null; function gt(e, t) { if (!_e(t)) return; const i = parseFloat(e.states[t]?.state ?? ""); return Number.isNaN(i) ? void 0 : Math.round(i) } function vt(e, t) { if (!_e(t)) return; const i = e.states[t]?.state; return "on" === i || "off" !== i && void 0 } function yt(e) { if (void 0 !== e) return "number" == typeof e ? { temp: e } : e } function bt(e, t) { const i = {}; for (const s of t) { const t = {}, o = gt(e, s.cooling), r = vt(e, s.useCooling); if (void 0 === o && void 0 === r || (t.cooling = { temp: o, use: r }), !1 !== s.has_heating) { const i = gt(e, s.heating), o = vt(e, s.useHeating); void 0 === i && void 0 === o || (t.heating = { temp: i, use: o }) } if (!1 !== s.has_fan) { const i = gt(e, s.fan), o = vt(e, s.useFan); void 0 === i && void 0 === o || (t.fan = { temp: i, use: o }) } const n = vt(e, s.fanOverride); void 0 !== n && (t.fanOverride = n), i[s.name] = t } return { version: 2, type: mt, rooms: i } } async function $t(e) { const t = JSON.stringify(e); if (_t = t, navigator.clipboard?.writeText) try { await navigator.clipboard.writeText(t) } catch { } } class xt { constructor(e) { this._feedback = {}, this._timers = {}, this._onChange = e } get(e) { return this._feedback[e] } flash(e, t, i = 2e3) { void 0 !== this._timers[e] && window.clearTimeout(this._timers[e]), this._feedback = { ...this._feedback, [e]: t }, this._onChange(), this._timers[e] = window.setTimeout(() => { const t = { ...this._feedback }; delete t[e], this._feedback = t, delete this._timers[e], this._onChange() }, i) } dispose() { for (const e of Object.values(this._timers)) window.clearTimeout(e); this._timers = {}, this._feedback = {} } } function wt(e, t) { return qe(t) } function At(e, t) { return e } function kt(e) { return Boolean(e && e.trim()) } function Et(e) { const t = e.room; return kt(e.enabled) && kt(e.time) && (kt(t.cooling) || kt(t.useCooling) || kt(t.heating) || kt(t.fan)) } async function St(e, t, i) { const s = function (e, t) { const i = Ge(t); if (i) return { name: i.label, roomKey: t, has_heating: i.has_heating, has_fan: i.has_fan, useCooling: e.use_ac, useHeating: i.has_heating ? e.use_heater : void 0, useFan: i.has_fan ? e.use_fan : void 0, fanOverride: e.ac_fan_only_override, cooling: e.target_cooling, heating: i.has_heating ? e.target_heating : void 0, fan: i.has_fan ? e.target_fan : void 0 } }(t, i); if (!s) return !1; const o = bt(e, [s]); return await $t(o), !0 } function Ct(e) { const t = e.split(":"); return t.length >= 2 ? `${t[0].padStart(2, "0")}:${t[1].padStart(2, "0")}` : e } function Pt(e, t, i, s) { const o = Ct(s); for (const s of wt(0, t)) { if (s.profileId === i) continue; const t = xe(e.states[s.time]?.state); if (t && t === o) return s } } function Nt(e) { const t = (e % 1440 + 1440) % 1440, i = Math.floor(t / 60), s = t % 60; return `${String(i).padStart(2, "0")}:${String(s).padStart(2, "0")}` } function Ot(e, t) { const i = function (e, t) { const i = new Set; for (const s of wt(0, t)) { const t = xe(e.states[s.time]?.state); t && i.add(Ct(t)) } return i }(e, t), s = new Date, o = 60 * s.getHours() + s.getMinutes(); let r = 15 * Math.floor(o / 15) + 15; r <= o && (r += 15); for (let e = 0; e < 96; e++) { const e = Nt(r); if (!i.has(e)) return e; r += 15 } return Nt(r) } const Ft = n`
  :host {
    display: block;
  }
...
`; let It = class extends ae {
  constructor() { super(...arguments), this._profilesOpen = !1, this._busy = !1, this._newProfileName = "", this._newProfileTime = "06:00", this._showAddForm = !1, this._addError = "", this._renameDrafts = {}, this._feedbackVersion = 0, this._fieldFeedback = {}, this._openProfileIds = new Set, this._focusAddName = !1, this._pasteRoomSettingsOnCreate = !1, this._buttonFeedback = new xt(() => { this._feedbackVersion += 1 }) } connectedCallback() { super.connectedCallback(), this._unsubStore = Be(() => this.requestUpdate()), je(this.hass) } disconnectedCallback() { super.disconnectedCallback(), this._unsubStore?.(), this._unsubStore = void 0, this._buttonFeedback.dispose() } _routines() { return qe(this.roomKey) } _flashField(e, t) { this._fieldFeedback = { ...this._fieldFeedback, [e]: t }, window.setTimeout(() => { if (this._fieldFeedback[e] !== t) return; const i = { ...this._fieldFeedback }; delete i[e], this._fieldFeedback = i }, 2e3) } _btnFeedback(e) { return this._feedbackVersion, this._buttonFeedback.get(e) } updated(e) { if (super.updated(e), this._focusAddName && this.shadowRoot && (this._focusAddName = !1, requestAnimationFrame(() => { const e = this.shadowRoot?.querySelector(".profile-add-name"); e?.focus() })), !this._focusTarget || !this.shadowRoot) return; const { profileId: t, selector: i } = this._focusTarget, s = new Set(this._openProfileIds); s.add(t), this._openProfileIds = s, requestAnimationFrame(() => { const e = this.shadowRoot?.querySelector(i); e?.focus(), this._focusTarget = void 0 }) } _renderActionButton(e, t, i, s, o = {}) {
    const r = this._btnFeedback(e), n = "success" === r ? "mdi:check" : "error" === r ? "mdi:alert-circle-outline" : i; return L`
      <button
        type="button"
    ...
    `} _renderDeviceRow(e, t, i, s) {
    const o = _e(i) ? ke(this.hass, i) : void 0, r = _e(t) ? ke(this.hass, t) : void 0, n = _e(s) ? ke(this.hass, s) : void 0; if (!o && !r && !n) return K; const a = Number(o?.attributes.min ?? 0), l = Number(o?.attributes.max ?? 100), c = Number(o?.attributes.step ?? 1), d = o ? parseFloat(o.state) : NaN, h = Number.isNaN(d) ? "" : String(Math.round(d)); return L`
    ...
    `: L`<div class="profile-hint">Preset entities loading… refresh in a moment.</div>`
  } async _copyProfile(e) { const t = `copy-${e.profileId}`; try { const i = bt(this.hass, [e.room]); await $t(i), this._buttonFeedback.flash(t, "success", 1500) } catch { this._buttonFeedback.flash(t, "error") } } async _pasteRoutine(e) { const t = `paste-${e.profileId}`, i = await async function () { if (navigator.clipboard?.readText) try { const e = await navigator.clipboard.readText(); if (e?.trim()) return _t = e, e } catch { } return _t }(); if (!i) return void this._buttonFeedback.flash(t, "error"); const s = function (e) { try { const t = JSON.parse(e); if ((1 === t?.version || 2 === t?.version) && t?.type === mt && t.rooms && "object" == typeof t.rooms) return t } catch { } return null }(i); if (!s) return void this._buttonFeedback.flash(t, "error"); const o = function (e, t, i, s, o) { let r = 0; for (const e of t) { const t = i.rooms[e.name]; if (!t) continue; void 0 !== t.fanOverride && _e(e.fanOverride) && (o(e.fanOverride, t.fanOverride), r++); const n = [{ key: "cooling", useId: e.useCooling, tempId: e.cooling, enabled: !0 }, { key: "heating", useId: e.useHeating, tempId: e.heating, enabled: !1 !== e.has_heating }, { key: "fan", useId: e.useFan, tempId: e.fan, enabled: !1 !== e.has_fan }]; for (const e of n) { if (!e.enabled) continue; const i = yt("cooling" === e.key ? t.cooling : "heating" === e.key ? t.heating : t.fan); i && (void 0 !== i.use && _e(e.useId) && (o(e.useId, i.use), r++), void 0 !== i.temp && _e(e.tempId) && (s(e.tempId, i.temp), r++)) } } return r }(this.hass, [e.room], s, (e, t) => $e(this.hass, e, t), (e, t) => function (e, t, i) { const s = t.split(".")[0]; e.callService(s, i ? "turn_on" : "turn_off", { entity_id: t }) }(this.hass, e, t)); 0 !== o ? this._buttonFeedback.flash(t, "success") : this._buttonFeedback.flash(t, "error") } async _copyCurrentRoom() { const e = "copy-room"; try { const t = await St(this.hass, this.config, this.roomKey); t && this._showAddForm && (this._pasteRoomSettingsOnCreate = !0), this._buttonFeedback.flash(e, t ? "success" : "error", 1500) } catch { this._buttonFeedback.flash(e, "error") } } async _applyNow(e) { const t = `apply-${e.profileId}`; this._busy = !0; try { await (i = this.hass, s = e.profileId, i.callWS({ type: "room_climate_controller/profiles/apply", profile_id: s })), this._buttonFeedback.flash(t, "success") } catch { this._buttonFeedback.flash(t, "error") } finally { this._busy = !1 } var i, s } _renameValue(e) { return void 0 !== this._renameDrafts[e.profileId] ? this._renameDrafts[e.profileId] : At(e.name, e.profileId) } _savedProfileName(e) { return At(e.name, e.profileId) } async _commitProfileName(e, t) { const i = t.trim(), s = this._savedProfileName(e), o = `name-${e.profileId}`; if (i === s) { const t = { ...this._renameDrafts }; return delete t[e.profileId], void (this._renameDrafts = t) } if (!i) { const t = { ...this._renameDrafts }; return delete t[e.profileId], this._renameDrafts = t, void this._flashField(o, "error") } this._busy = !0; try { await function (e, t, i) { return e.callWS({ type: "room_climate_controller/profiles/rename", profile_id: t, name: i }) }(this.hass, e.profileId, i); const t = { ...this._renameDrafts }; delete t[e.profileId], this._renameDrafts = t, await je(this.hass), this._flashField(o, "success") } catch { this._flashField(o, "error") } finally { this._busy = !1 } } async _setProfileTime(e, t) { const i = `time-${e.profileId}`; var s, o, r; if (Pt(this.hass, this.roomKey, e.profileId, t)) this._flashField(i, "error"); else if (_e(e.time)) try { await (s = this.hass, o = e.time, r = `${t}:00`, "input_datetime" === o.split(".")[0] ? s.callService("input_datetime", "set_datetime", { entity_id: o, time: r }) : s.callService("time", "set_value", { entity_id: o, time: r })), await je(this.hass), this._flashField(i, "success") } catch { this._flashField(i, "error") } } _timeConflictMessage(e) { const t = Pt(this.hass, this.roomKey, "", e); if (!t) return "Another profile in this room already uses that time."; return `“${At(t.name, t.profileId)}” already runs at ${e} in this room.` } async _addProfile() { const e = "add-profile", t = "add-profile-time", i = this._newProfileName.trim(), s = Ct(this._newProfileTime); if (this._addError = "", !i) return this._addError = "Enter a profile name.", void this._buttonFeedback.flash(e, "error"); if (!s) return this._addError = "Choose a valid time.", void this._flashField(t, "error"); if (Pt(this.hass, this.roomKey, "", s)) return this._addError = this._timeConflictMessage(s), void this._flashField(t, "error"); this._busy = !0; try { const t = await (o = this.hass, r = { name: i, room: this.roomKey, time: s, copy_room_settings: this._pasteRoomSettingsOnCreate }, o.callWS({ type: "room_climate_controller/profiles/create", ...r })); await je(this.hass), this._pasteRoomSettingsOnCreate = !1; const n = t.profile?.id; n && (this._openProfileIds = new Set([...this._openProfileIds, n])), this._newProfileName = "", this._newProfileTime = Ot(this.hass, this.roomKey), this._showAddForm = !1, this._addError = "", this._buttonFeedback.flash(e, "success") } catch (t) { this._addError = function (e) { if (e && "object" == typeof e && "message" in e) { const t = e.message; if ("string" == typeof t) return t.trim() } return "" }(t) || "Could not create profile. Check Settings → System → Logs.", this._buttonFeedback.flash(e, "error") } finally { this._busy = !1 } var o, r } async _deleteProfile(e) { const t = `delete-${e.profileId}`, i = At(e.name, e.profileId); if (window.confirm(`Delete profile “${i}”?`)) { this._busy = !0; try { await (s = this.hass, o = e.profileId, s.callWS({ type: "room_climate_controller/profiles/delete", profile_id: o })); const i = new Set(this._openProfileIds); i.delete(e.profileId), this._openProfileIds = i, await je(this.hass), this._buttonFeedback.flash(t, "success", 800) } catch { this._buttonFeedback.flash(t, "error") } finally { this._busy = !1 } var s, o } } _renderProfile(e) {
    const t = _e(e.time) ? xe(this.hass.states[e.time]?.state) : "", i = At(e.name, e.profileId), s = function (e, t) { const i = xe(e.states[t.time]?.state); return !!i && Boolean(Pt(e, t.roomKey, t.profileId, i)) }(this.hass, e), o = `time-${e.profileId}`, r = `name-${e.profileId}`; return L`
      <details
        class="profile-item"
    ...
    `} render() {
    const e = this._routines(), t = e.filter(Et); return L`
      <details
    ...
    `} static get styles() { return Ft }
}; e([pe({ attribute: !1 })], It.prototype, "hass", void 0), e([pe({ attribute: !1 })], It.prototype, "config", void 0), e([pe({ attribute: !1 })], It.prototype, "roomKey", void 0), e([ue()], It.prototype, "_profilesOpen", void 0), e([ue()], It.prototype, "_busy", void 0), e([ue()], It.prototype, "_newProfileName", void 0), e([ue()], It.prototype, "_newProfileTime", void 0), e([ue()], It.prototype, "_showAddForm", void 0), e([ue()], It.prototype, "_addError", void 0), e([ue()], It.prototype, "_renameDrafts", void 0), e([ue()], It.prototype, "_feedbackVersion", void 0), e([ue()], It.prototype, "_fieldFeedback", void 0), e([ue()], It.prototype, "_openProfileIds", void 0), e([ue()], It.prototype, "_focusTarget", void 0), e([ue()], It.prototype, "_focusAddName", void 0), e([ue()], It.prototype, "_pasteRoomSettingsOnCreate", void 0), It = e([ce("room-climate-profiles-panel")], It), window.customCards = window.customCards || [], window.customCards.push({ type: "room-climate-control", name: "Room Climate Control", description: "Per-room climate dashboard card wired to a room's backend helpers and devices.", preview: !0 }), console.info("%c ROOM-CLIMATE-CONTROL %c v1.4.32 ", "color: white; background: #0288d1; font-weight: 700;", "color: #0288d1; background: white; font-weight: 700;");
