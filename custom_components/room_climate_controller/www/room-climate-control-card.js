 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let _t=null;function gt(e,t){if(!_e(t))return;const i=parseFloat(e.states[t]?.state??"");return Number.isNaN(i)?void 0:Math.round(i)}function vt(e,t){if(!_e(t))return;const i=e.states[t]?.state;return"on"===i||"off"!==i&&void 0}function yt(e){if(void 0!==e)return"number"==typeof e?{temp:e}:e}function bt(e,t){const i={};for(const s of t){const t={},o=gt(e,s.cooling),r=vt(e,s.useCooling);if(void 0===o&&void 0===r||(t.cooling={temp:o,use:r}),!1!==s.has_heating){const i=gt(e,s.heating),o=vt(e,s.useHeating);void 0===i&&void 0===o||(t.heating={temp:i,use:o})}if(!1!==s.has_fan){const i=gt(e,s.fan),o=vt(e,s.useFan);void 0===i&&void 0===o||(t.fan={temp:i,use:o})}const n=vt(e,s.fanOverride);void 0!==n&&(t.fanOverride=n),i[s.name]=t}return{version:2,type:mt,rooms:i}}async function $t(e){const t=JSON.stringify(e);if(_t=t,navigator.clipboard?.writeText)try{await navigator.clipboard.writeText(t)}catch{}}class xt{constructor(e){this._feedback={},this._timers={},this._onChange=e}get(e){return this._feedback[e]}flash(e,t,i=2e3){void 0!==this._timers[e]&&window.clearTimeout(this._timers[e]),this._feedback={...this._feedback,[e]:t},this._onChange(),this._timers[e]=window.setTimeout(()=>{const t={...this._feedback};delete t[e],this._feedback=t,delete this._timers[e],this._onChange()},i)}dispose(){for(const e of Object.values(this._timers))window.clearTimeout(e);this._timers={},this._feedback={}}}function wt(e,t){return qe(t)}function At(e,t){return e}function kt(e){return Boolean(e&&e.trim())}function Et(e){const t=e.room;return kt(e.enabled)&&kt(e.time)&&(kt(t.cooling)||kt(t.useCooling)||kt(t.heating)||kt(t.fan))}async function Ct(e,t,i){const s=function(e,t){const i=Ge(t);if(i)return{name:i.label,roomKey:t,has_heating:i.has_heating,has_fan:i.has_fan,useCooling:e.use_ac,useHeating:i.has_heating?e.use_heater:void 0,useFan:i.has_fan?e.use_fan:void 0,fanOverride:e.ac_fan_only_override,cooling:e.target_cooling,heating:i.has_heating?e.target_heating:void 0,fan:i.has_fan?e.target_fan:void 0}}(t,i);if(!s)return!1;const o=bt(e,[s]);return await $t(o),!0}function St(e){const t=e.split(":");return t.length>=2?`${t[0].padStart(2,"0")}:${t[1].padStart(2,"0")}`:e}function Pt(e,t,i,s){const o=St(s);for(const s of wt(0,t)){if(s.profileId===i)continue;const t=xe(e.states[s.time]?.state);if(t&&t===o)return s}}function Nt(e){const t=(e%1440+1440)%1440,i=Math.floor(t/60),s=t%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function Ot(e,t){const i=function(e,t){const i=new Set;for(const s of wt(0,t)){const t=xe(e.states[s.time]?.state);t&&i.add(St(t))}return i}(e,t),s=new Date,o=60*s.getHours()+s.getMinutes();let r=15*Math.floor(o/15)+15;r<=o&&(r+=15);for(let e=0;e<96;e++){const e=Nt(r);if(!i.has(e))return e;r+=15}return Nt(r)}const Ft=n`
  :host {
    display: block;
  }
