 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ue(e){return pe({...e,state:!0,attribute:!1})}const fe="sensor.outdoor_temperature",me="input_select.time_range";function _e(e,t,i,s){if(!e)return null;const o="fan"===s?'(\n    (state && state.state) ||\n    y\n  ) === "off" ? 0 : 1':function(e){return`(\n    (state && state.attributes && state.attributes.hvac_mode) ||\n    (state && state.state) ||\n    y\n  ) === "${"cooling"===e?"cool":"heat"}" ? 1 : 0`}(s);return{entity:e,filters:[{map_y:o}],name:`$ex '${t}: ' + (Number(ys.at(-1)) === 1 ? 'On' : Number(ys.at(-1)) === 0 ? 'Off' : '—')`,hovertemplate:"%{x|%H:%M}: %{y}<extra></extra>",yaxis:"y2",visible:`$ex hass.states['${e}'] !== undefined`,line:{shape:"hv",color:i,width:1.5}}}function ge(e){return Boolean(e&&e.trim())}function ve(e,t,i="—"){if(!ge(t)||!e.states[t])return i;const s=e.states[t];if("unavailable"===s.state||"unknown"===s.state)return i;const o=s.attributes.unit_of_measurement||"",r=parseFloat(s.state);return Number.isNaN(r)?e.formatEntityState(s):`${Number.isInteger(r)?r:r.toFixed(1)}${o?` ${o}`:""}`}function ye(e,t){if(!ge(t)||!e.states[t])return"—";const i=e.states[t].state;if("unavailable"===i||"unknown"===i)return"—";const s=Math.round(parseFloat(i));return Number.isNaN(s)?"—":`${s} W now`}function be(e,t){const i=e.states[t];if(!i)return"—";return(i.attributes.hvac_mode||i.state).replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}function $e(e,t){const i=e.states[t];if(!i)return"—";if("off"===i.state)return"Off";const s=i.attributes.percentage;return null!=s?`${s}%`:i.state.replace(/\b\w/g,e=>e.toUpperCase())}function xe(e,t,i){const s=t.split(".")[0];e.callService(s,"set_value",{entity_id:t,value:i})}function we(e){if(!e||"unknown"===e||"unavailable"===e)return"";const t=e.split(":");return t.length>=2?`${t[0].padStart(2,"0")}:${t[1].padStart(2,"0")}`:e}function Ae(e,t){e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}async function ke(e,t){if(!await async function(e,t=15e3){if(customElements.get(e))return!0;try{return await Promise.race([customElements.whenDefined(e),new Promise((i,s)=>{setTimeout(()=>s(new Error(`Timed out waiting for ${e}`)),t)})]),!0}catch{return!1}}("plotly-graph"))return null;const{type:i,...s}=t,o=document.createElement("plotly-graph");return o.setConfig(s),o.hass=e,o}function Ee(e,t){return e.states[t]}function Ce(e,t,i=0){const s=parseFloat(e.states[t]?.state??"");return Number.isNaN(s)?i:s}function Se(e,t,i,s){if(!ge(t)||!ge(i))return null;const o=Ce(e,t),r=Ce(e,i,1);return s?o-r:o+r}function Pe(e,t,i){e.callService(t.split(".")[0],"set_value",{entity_id:t,value:i})}function Ne(e,t,i,s){const o=Ee(e,t);if(!o)return K;const r=Number(o.attributes.min??1),n=Number(o.attributes.max??20),a=Number(o.attributes.step??1),l=Ce(e,t,r);return L`
    <div class="settings-row">
      ...
      <div class="settings-row-control settings-slider-control">
        <input
          ...
          step=${a}
          .value=${String(l)}
          @input=${i=>{const s=parseFloat(i.target.value);Number.isNaN(s)||Pe(e,t,s)}}
        />
        <span class="settings-offset-value">${l}°F</span>
      </div>
    </div>
  `}function Oe(e,t,i){const s=Boolean(t.subtractOffsets),o=Se(e,t.target,t.mediumOffset,s),r=Se(e,t.target,t.highOffset,s);return L`
    <div class="settings-section">
      <div class="settings-section-title">${t.title}</div>
      ${function(e,t,i){const s=Ee(e,t);if(!s)return K;const o=Number(s.attributes.min??0),r=Number(s.attributes.max??100),n=Number(s.attributes.step??1),a=Ce(e,t);return L`
    <div class="settings-row">
      <span class="settings-row-label">${i}</span>
      <div class="settings-row-control settings-target-control">
        <input
          ...
          step=${n}
          .value=${String(a)}
          @change=${i=>{const s=parseFloat(i.target.value);Number.isNaN(s)||Pe(e,t,s)}}
        />
        <span class="settings-unit">°F</span>
      </div>
    </div>
  `}(e,t.target,"Target")}
      ${Ne(e,t.mediumOffset,"Medium offset",o)}
      ${Ne(e,t.highOffset,"High offset",r)}
      ${t.deviceButton&&i?L`
...
`;function Re(e){return e.callWS({type:"room_climate_controller/rooms/list"})}function Me(e){return e.callWS({type:"room_climate_controller/profiles/list"})}let De=[],He=[],Ue=!1,ze=null;const je=new Set;function Be(e){return je.add(e),()=>je.delete(e)}async function Le(e){return ze||(ze=(async()=>{try{const[t,i]=await Promise.all([Re(e),Me(e)]);De=t.rooms??[],He=i.profiles??[],Ue=!0,function(){for(const e of je)e()}()}catch{}finally{ze=null}})(),ze)}function Ge(){return De}function Ke(e){return De.find(t=>t.key===e)}function We(){return De.map(e=>({key:e.key,label:e.label,has_heating:e.has_heating,has_fan:e.has_fan}))}function qe(e){const t=e.entities.presets??{},i={name:Ke(e.room)?.label??e.room,roomKey:e.room,has_heating:e.has_heating,has_fan:e.has_fan,useCooling:t.cooling?.use_entity??void 0,useHeating:t.heating?.use_entity??void 0,useFan:t.fan?.use_entity??void 0,fanOverride:e.entities.fan_override??void 0,cooling:t.cooling?.temp_entity??"",heating:t.heating?.temp_entity??void 0,fan:t.fan?.temp_entity??void 0};return{profileId:e.id,name:e.name,enabled:e.entities.enabled??"",time:e.entities.time??"",roomKey:e.room,room:i}}function Ve(e){return He.filter(t=>t.room===e).map(qe).sort((e,t)=>{const i=Je(e.profileId),s=Je(t.profileId);return i!==s?i.localeCompare(s):e.profileId.localeCompare(t.profileId,void 0,{numeric:!0})})}function Je(e){return He.find(t=>t.id===e)?.time??"99:99"}const Ze={use:null,target:null,medium_offset:null,high_offset:null};function Ye(e){return e.room?.trim()||e.profile_room_key?.trim()||void 0}function Qe(e){const t=Ye(e);if(!t)return;const i=Ke(t);if(!i)return;const s=i.entities,o=e=>s.live[e]??Ze,r=o("cooling"),n=o("heating"),a=o("fan");return function(e={}){return{type:"custom:room-climate-control",room_name:"Room",temp_sensor:"",use_ac:"",use_heater:"",use_fan:"",manual_mode:"",target_cooling:"",cooling_medium_offset:"",cooling_high_offset:"",target_heating:"",heating_medium_offset:"",heating_high_offset:"",target_fan:"",fan_medium_offset:"",fan_high_offset:"",outdoor_sensor:fe,time_range:me,...e}}({type:"custom:room-climate-control",room:t,profile_room_key:t,room_name:i.label,temp_sensor:s.temperature??"",humidity_sensor:s.humidity??"",power_sensor:s.power??"",ac_entity:s.ac_entity??"",heater_entity:s.heater_entity??"",fan_entity:s.fan_entity??"",manual_mode:s.manual_mode??"",ac_fan_only_override:s.ac_fan_only_override??"",heater_fan_only_override:s.heater_fan_only_override??"",use_ac:r.use??"",target_cooling:r.target??"",cooling_medium_offset:r.medium_offset??"",cooling_high_offset:r.high_offset??"",use_heater:n.use??"",target_heating:n.target??"",heating_medium_offset:n.medium_offset??"",heating_high_offset:n.high_offset??"",use_fan:a.use??"",target_fan:a.target??"",fan_medium_offset:a.medium_offset??"",fan_high_offset:a.high_offset??"",outdoor_sensor:e.outdoor_sensor??s.outdoor??fe,time_range:e.time_range??me,ac_device_button:e.ac_device_button,heater_device_button:e.heater_device_button,fan_device_button:e.fan_device_button})}let Xe=class extends ae{constructor(){super(...arguments),this._settingsOpen=!1,this._graphDialog=null,this._graphOverlay=new Ie}setConfig(e){if(this._userConfig=e,!Ye(e))return this._config=void 0,void(this._configError="Select a room in the card editor.");this._configError=void 0,this._resolveRoom()}_resolveRoom(){const e=Qe(this._userConfig);if(e)return this._config=e,void(this._configError=void 0);const t=Ye(this._userConfig);Ge().length>0&&t&&!function(e){return Ge().some(t=>t.key===e)}(t)&&(this._config=void 0,this._configError=`Unknown room "${t}". Add it in the Room Climate integration.`)}getCardSize(){return 6}static getConfigElement(){return document.createElement("room-climate-control-editor")}static getStubConfig(){const e=Ge()[0]?.key;return{type:"custom:room-climate-control",room:e??""}}connectedCallback(){super.connectedCallback(),Le(this.hass),this._unsubRooms??=Be(()=>{this._resolveRoom(),this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._graphOverlay.close(),this._unsubRooms?.(),this._unsubRooms=void 0}updated(e){if(!(e.has("hass")&&this._graphDialog&&this.hass&&this._config))return;this._overlayGraphEl&&(this._overlayGraphEl.hass=this.hass),this._overlayPowerNowEl&&ge(this._config.power_sensor)&&(this._overlayPowerNowEl.textContent=ye(this.hass,this._config.power_sensor));const t=this._config.time_range||me,i=this.hass.states[t]?.state;i&&i!==this._lastGraphHours&&(this._lastGraphHours=i,this._mountGraphOverlay())}render(){if(!this.hass)return L``;if(this._configError)return L`
        <ha-card>
    ...
    `}_renderProfilesPanel(e){const t=function(e){const t=e.profile_room_key?.trim();if(t)return t;const i=e.manual_mode?.trim();if(i){const e=Ge().find(e=>e.entities.manual_mode===i);if(e)return e.key}const s=e.manual_mode?.match(/^input_boolean\.([a-z0-9_]+)_climate_manual_mode$/);return s&&Ge().some(e=>e.key===s[1])?s[1]:void 0}(e);return t?L`
      <room-climate-profiles-panel
        .hass=${this.hass}
        .config=${e}
        .roomKey=${t}
      ></room-climate-profiles-panel>
    `:K}_renderDevicesPanel(e){const t=[],i=(e,i,s,o,r,n)=>{if(!ge(i)||!function(e,t){if(!ge(t))return!1;const i=e.states[t];return!!i&&"unavailable"!==i.state&&"unknown"!==i.state}(this.hass,i))return;const a=Ee(this.hass,s);if(!a)return;const l=i,c=function(e,t,i=72){const s=e.states[t];if(!s)return i;const o=parseFloat(s.state);return Number.isNaN(o)?i:Math.round(o)}(this.hass,o),d=r(this.hass,l),h=ge(n)&&function(e,t){if(!ge(t)||!e.states[t])return!1;const i=e.states[t],s=i.attributes.hvac_modes;if(Array.isArray(s)&&s.includes("fan_only"))return!0;const o=i.attributes.fan_modes;return Array.isArray(o)&&o.length>0}(this.hass,l),p=h?Ee(this.hass,n):void 0;t.push(L`
        <div class="device-row">
          <div
            ...
            tabindex="0"
            @click=${()=>Ae(this,l)}
            @keydown=${e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),Ae(this,l))}}
          >
      ...
      `)},s=ge(e.ac_entity)&&ge(e.heater_entity)&&e.ac_entity===e.heater_entity;if(i("Cooling",e.ac_entity,e.use_ac,e.target_cooling,be,e.ac_fan_only_override),i("Heating",e.heater_entity,e.use_heater,e.target_heating,be,s?void 0:e.heater_fan_only_override),i("Fan",e.fan_entity,e.use_fan,e.target_fan,$e),0===t.length)return K;const o=Ee(this.hass,e.manual_mode);return o&&t.push(L`
      ...
      `),L`<div class="devices-section">${t}</div>`}_renderSettingsDialog(){if(!this._config)return K;const e=function(e){const t=[];return ge(e.ac_entity)&&t.push({title:"Cooling",target:e.target_cooling,mediumOffset:e.cooling_medium_offset,highOffset:e.cooling_high_offset,deviceButton:e.ac_device_button}),ge(e.heater_entity)&&t.push({title:"Heating",target:e.target_heating,mediumOffset:e.heating_medium_offset,highOffset:e.heating_high_offset,subtractOffsets:!0,deviceButton:e.heater_device_button}),ge(e.fan_entity)&&t.push({title:"Fan",target:e.target_fan,mediumOffset:e.fan_medium_offset,highOffset:e.fan_high_offset,deviceButton:e.fan_device_button}),t}(this._config);return L`
      <ha-dialog
        open
  ...
  `}(this.hass,this._config)}
    ...
    `}_onSettingsDeviceButton(e,t){t.disabled||(t.disabled=!0,async function(e,t){const i=t.action;if("perform-action"!==i&&"call-service"!==i)return;const s=t.perform_action??t.service;if(!s?.includes("."))return;const[o,r]=s.split(".",2),n={...t.data??{}},a=t.target;void 0!==a?.entity_id&&(n.entity_id=a.entity_id),await e.callService(o,r,n)}(this.hass,e.tap_action).finally(()=>{window.setTimeout(()=>{t.disabled=!1},1e3)}))}_openSettings(){this._closeGraphDialog(),this._settingsOpen=!0}_closeSettings(){this._settingsOpen=!1}_openGraphDialog(e){this._config&&(this._closeSettings(),this._graphDialog=e,this._lastGraphHours=this.hass.states[this._config.time_range||me]?.state,this._mountGraphOverlay())}_closeGraphDialog(){this._graphOverlay.isOpen?this._graphOverlay.close():this._clearGraphDialogState()}_clearGraphDialogState(){this._graphDialog=null,this._lastGraphHours=void 0,this._overlayGraphEl=void 0,this._overlayPowerNowEl=void 0}async _mountGraphOverlay(){if(!this._graphDialog||!this.hass||!this._config)return;const e=this._config,t={energy:`${e.room_name} · Energy Use`,history:`${e.room_name} · History`},i=this._graphOverlay.open(t[this._graphDialog],()=>{this._clearGraphDialogState()});i.innerHTML="",this._overlayGraphEl=void 0,this._overlayPowerNowEl=void 0;const s=e.time_range||me,o=parseInt(this.hass.states[s]?.state||"24",10)||24,r=await async function(e,t){if(!window.loadCardHelpers)return null;const i=await window.loadCardHelpers(),s=await i.createCardElement(t);return s&&(s.hass=e),s}(this.hass,function(e){return{type:"entities",entities:[{entity:e,name:"Time range (hours)"}]}}(s));if(r&&i.appendChild(r),"energy"===this._graphDialog){if(ge(e.power_sensor)){const t=document.createElement("div");t.className="rcc-overlay-power-now",t.textContent=ye(this.hass,e.power_sensor),i.appendChild(t),this._overlayPowerNowEl=t}const t=document.createElement("div");t.className="rcc-overlay-graph-host",i.appendChild(t);const r=await ke(this.hass,function(e,t){return{type:"custom:plotly-graph",hours_to_show:t,refresh_interval:60,config:{displayModeBar:!1,scrollZoom:!1},entities:[{entity:e.power_sensor,filters:["force_numeric"],name:"$ex 'Power: ' + (ys.at(-1) != null ? Math.round(ys.at(-1)) + ' W' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.0f} W<extra></extra>",line:{color:"rgb(255,165,0)",width:2}}],layout:{dragmode:!1,height:400,legend:{orientation:"h",yanchor:"bottom",y:1.02,xanchor:"center",x:.5},margin:{t:40,r:20},yaxis:{title:"Watts",showgrid:!1,zeroline:!1,rangemode:"tozero",fixedrange:!0},xaxis:{showgrid:!1,fixedrange:!0}}}}(e,o));return r?(t.appendChild(r),this._overlayGraphEl=r):t.textContent="Unable to load energy graph (plotly-graph unavailable).",void(this._lastGraphHours=this.hass.states[s]?.state)}const n=document.createElement("div");n.className="rcc-overlay-graph-host",i.appendChild(n);const a=await ke(this.hass,function(e,t){const i=e.outdoor_sensor||fe,s=[{entity:e.temp_sensor,filters:["force_numeric",{fn:"({ xs, ys, vars }) => {\n            vars._roomTempVals = ys.map(Number).filter((n) => !isNaN(n));\n            return { xs, ys };\n          }"}],name:"$ex 'Room: ' + (ys.at(-1) != null ? ys.at(-1).toFixed(1) + ' °F' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.1f} °F<extra></extra>",yaxis:"y",line:{color:"rgb(255,165,0)",width:2}},{entity:i,filters:["force_numeric",{fn:"({ xs, ys, vars }) => {\n            const outdoor = ys.map(Number).filter((n) => !isNaN(n));\n            const all = [...(vars._roomTempVals || []), ...outdoor];\n            if (all.length) {\n              const dmin = Math.min(...all);\n              const dmax = Math.max(...all);\n              vars.tempYRange = [Math.min(20, dmin) - 1, Math.max(100, dmax) + 1];\n            } else {\n              vars.tempYRange = [20, 100];\n            }\n            return { xs, ys };\n          }"}],name:"$ex 'Outdoor: ' + (ys.at(-1) != null ? ys.at(-1).toFixed(1) + ' °F' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.1f} °F<extra></extra>",yaxis:"y",line:{color:"rgb(100,180,255)",width:2}}],o=_e(e.ac_entity,"Cooling","rgb(30,144,255)","cooling"),r=_e(e.heater_entity,"Heating","rgb(220,60,60)","heating"),n=_e(e.fan_entity,"Fan","rgb(0,180,160)","fan");return o&&s.push(o),r&&s.push(r),n&&s.push(n),{type:"custom:plotly-graph",hours_to_show:t,refresh_interval:60,config:{displayModeBar:!1,scrollZoom:!1},entities:s,layout:{dragmode:!1,height:400,legend:{orientation:"h",yanchor:"bottom",y:1.02,xanchor:"center",x:.5},margin:{t:0,r:60},yaxis:{title:"°F",showgrid:!1,zeroline:!1,range:"$ex vars.tempYRange || [20, 100]",autorange:!1,fixedrange:!0},yaxis2:{title:"State",showgrid:!1,zeroline:!1,overlaying:"y",side:"right",range:[0,1.2],autorange:!1,fixedrange:!0,tickvals:[0,1],ticktext:["Off","On"]},xaxis:{showgrid:!1,fixedrange:!0}}}}(e,o));a?(n.appendChild(a),this._overlayGraphEl=a):n.textContent="Unable to load history graph (plotly-graph unavailable).",this._lastGraphHours=this.hass.states[s]?.state}static get styles(){return Te}};e([pe({attribute:!1})],Xe.prototype,"hass",void 0),e([ue()],Xe.prototype,"_config",void 0),e([ue()],Xe.prototype,"_configError",void 0),e([ue()],Xe.prototype,"_settingsOpen",void 0),e([ue()],Xe.prototype,"_graphDialog",void 0),Xe=e([ce("room-climate-control")],Xe);const et={room:"Room",outdoor_sensor:"Outdoor temperature sensor (graph)",time_range:"Graph time-range helper",ac_device_button:"A/C lights & sound button (tap_action)",heater_device_button:"Heater lights & sound button (tap_action)",fan_device_button:"Fan lights & sound button (tap_action)"},tt=["outdoor_sensor","time_range","ac_device_button","heater_device_button","fan_device_button"],it=[{name:"outdoor_sensor",selector:{entity:{filter:[{domain:"sensor",device_class:"temperature"}]}}},{name:"time_range",selector:{entity:{filter:[{domain:"input_select"}]}}}],st=[{name:"ac_device_button",selector:{object:{}}},{name:"heater_device_button",selector:{object:{}}},{name:"fan_device_button",selector:{object:{}}}];let ot=class extends ae{constructor(){super(...arguments),this._schemaKey="",this._computeLabel=e=>et[e.name]||e.name}setConfig(e){this._config={...e,type:"custom:room-climate-control"}}connectedCallback(){super.connectedCallback(),this.hass&&Le(this.hass),this._unsub??=Be(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=void 0}_getSchema(e){const t=e.map(e=>e.key).join(",");return this._schema&&t===this._schemaKey||(this._schema=function(e){return[{name:"room",required:!0,selector:{select:{mode:"dropdown",options:e.map(e=>({value:e.key,label:e.label}))}}},...it,...st]}(e),this._schemaKey=t),this._schema}render(){if(!this.hass||!this._config)return L``;const e=We();return L`
      ...
      <ha-form
        .hass=${this.hass}
        .data=${t=this._config,{room:t.room??"",outdoor_sensor:t.outdoor_sensor??"",time_range:t.time_range??"",ac_device_button:t.ac_device_button,heater_device_button:t.heater_device_button,fan_device_button:t.fan_device_button}}
        .schema=${this._getSchema(e)}
        .computeLabel=${this._computeLabel}
        @value-changed=${this._valueChanged}
      ></ha-form>
    `;var t}_valueChanged(e){e.stopPropagation();const t=e.detail.value,i={...this._config,...t,type:"custom:room-climate-control"},s=i;for(const e of tt){const t=s[e];(null==t||""===t||"object"==typeof t&&0===Object.keys(t).length)&&delete s[e]}var o,r;this._config=i,o=this,r=this._config,o.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:r}}))}static get styles(){return n`
      :host {
        display: block;
        padding: 16px;
      }
    ...
    `}};e([pe({attribute:!1})],ot.prototype,"hass",void 0),e([ue()],ot.prototype,"_config",void 0),ot=e([ce("room-climate-control-editor")],ot);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rt=2;let nt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:at}=oe,lt=e=>e,ct=()=>document.createComment(""),dt=(e,t,i)=>{const s=e._$AA.parentNode,o=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(ct(),o),r=s.insertBefore(ct(),o);i=new at(t,r,e,e.options)}else{const t=i._$AB.nextSibling,r=i._$AM,n=r!==e;if(n){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==r._$AU&&i._$AP(t)}if(t!==o||n){let e=i._$AA;for(;e!==t;){const t=lt(e).nextSibling;lt(s).insertBefore(e,o),e=t}}}return i},ht=(e,t,i=e)=>(e._$AI(t,i),e),pt={},ut=(e,t=pt)=>e._$AH=t,ft=e=>{e._$AR(),e._$AA.remove()},mt=(e,t,i)=>{const s=new Map;for(let o=t;o<=i;o++)s.set(e[o],o);return s},_t=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends nt{constructor(e){if(super(e),e.type!==rt)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const o=[],r=[];let n=0;for(const t of e)o[n]=s?s(t,n):n,r[n]=i(t,n),n++;return{values:r,keys:o}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){const o=(e=>e._$AH)(e),{values:r,keys:n}=this.dt(t,i,s);if(!Array.isArray(o))return this.ut=n,r;const a=this.ut??=[],l=[];let c,d,h=0,p=o.length-1,u=0,f=r.length-1;for(;h<=p&&u<=f;)if(null===o[h])h++;else if(null===o[p])p--;else if(a[h]===n[u])l[u]=ht(o[h],r[u]),h++,u++;else if(a[p]===n[f])l[f]=ht(o[p],r[f]),p--,f--;else if(a[h]===n[f])l[f]=ht(o[h],r[f]),dt(e,l[f+1],o[h]),h++,f--;else if(a[p]===n[u])l[u]=ht(o[p],r[u]),dt(e,o[h],o[p]),p--,u++;else if(void 0===c&&(c=mt(n,u,f),d=mt(a,h,p)),c.has(a[h]))if(c.has(a[p])){const t=d.get(n[u]),i=void 0!==t?o[t]:null;if(null===i){const t=dt(e,o[h]);ht(t,r[u]),l[u]=t}else l[u]=ht(i,r[u]),dt(e,o[h],i),o[t]=null;u++}else ft(o[p]),p--;else ft(o[h]),h++;for(;u<=f;){const t=dt(e,l[f+1]);ht(t,r[u]),l[u++]=t}for(;h<=p;){const e=o[h++];null!==e&&ft(e)}return this.ut=n,ut(e,l),G}}),gt="daily-routine-climate-temps";
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let vt=null;function yt(e,t){if(!ge(t))return;const i=parseFloat(e.states[t]?.state??"");return Number.isNaN(i)?void 0:Math.round(i)}function bt(e,t){if(!ge(t))return;const i=e.states[t]?.state;return"on"===i||"off"!==i&&void 0}function $t(e){if(void 0!==e)return"number"==typeof e?{temp:e}:e}function xt(e,t){const i={};for(const s of t){const t={},o=yt(e,s.cooling),r=bt(e,s.useCooling);if(void 0===o&&void 0===r||(t.cooling={temp:o,use:r}),!1!==s.has_heating){const i=yt(e,s.heating),o=bt(e,s.useHeating);void 0===i&&void 0===o||(t.heating={temp:i,use:o})}if(!1!==s.has_fan){const i=yt(e,s.fan),o=bt(e,s.useFan);void 0===i&&void 0===o||(t.fan={temp:i,use:o})}const n=bt(e,s.fanOverride);void 0!==n&&(t.fanOverride=n),i[s.name]=t}return{version:2,type:gt,rooms:i}}async function wt(e){const t=JSON.stringify(e);if(vt=t,navigator.clipboard?.writeText)try{await navigator.clipboard.writeText(t)}catch{}}class At{constructor(e){this._feedback={},this._timers={},this._onChange=e}get(e){return this._feedback[e]}flash(e,t,i=2e3){void 0!==this._timers[e]&&window.clearTimeout(this._timers[e]),this._feedback={...this._feedback,[e]:t},this._onChange(),this._timers[e]=window.setTimeout(()=>{const t={...this._feedback};delete t[e],this._feedback=t,delete this._timers[e],this._onChange()},i)}dispose(){for(const e of Object.values(this._timers))window.clearTimeout(e);this._timers={},this._feedback={}}}function kt(e,t){return Ve(t)}function Et(e,t){return e}function Ct(e){return Boolean(e&&e.trim())}function St(e){const t=e.room;return Ct(e.enabled)&&Ct(e.time)&&(Ct(t.cooling)||Ct(t.useCooling)||Ct(t.heating)||Ct(t.fan))}async function Pt(e,t,i){const s=function(e,t){const i=Ke(t);if(i)return{name:i.label,roomKey:t,has_heating:i.has_heating,has_fan:i.has_fan,useCooling:e.use_ac,useHeating:i.has_heating?e.use_heater:void 0,useFan:i.has_fan?e.use_fan:void 0,fanOverride:e.ac_fan_only_override,cooling:e.target_cooling,heating:i.has_heating?e.target_heating:void 0,fan:i.has_fan?e.target_fan:void 0}}(t,i);if(!s)return!1;const o=xt(e,[s]);return await wt(o),!0}function Nt(e){const t=e.split(":");return t.length>=2?`${t[0].padStart(2,"0")}:${t[1].padStart(2,"0")}`:e}function Ot(e,t,i,s){const o=Nt(s);for(const s of kt(0,t)){if(s.profileId===i)continue;const t=we(e.states[s.time]?.state);if(t&&t===o)return s}}function Ft(e){const t=(e%1440+1440)%1440,i=Math.floor(t/60),s=t%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function It(e,t){const i=function(e,t){const i=new Set;for(const s of kt(0,t)){const t=we(e.states[s.time]?.state);t&&i.add(Nt(t))}return i}(e,t),s=new Date,o=60*s.getHours()+s.getMinutes();let r=15*Math.floor(o/15)+15;r<=o&&(r+=15);for(let e=0;e<96;e++){const e=Ft(r);if(!i.has(e))return e;r+=15}return Ft(r)}const Tt=n`
  :host {
    display: block;
  }
...
`;let Rt=class extends ae{constructor(){super(...arguments),this._profilesOpen=!1,this._busy=!1,this._newProfileName="",this._newProfileTime="06:00",this._showAddForm=!1,this._addError="",this._renameDrafts={},this._feedbackVersion=0,this._fieldFeedback={},this._openProfileIds=new Set,this._focusAddName=!1,this._pasteRoomSettingsOnCreate=!1,this._buttonFeedback=new At(()=>{this._feedbackVersion+=1})}connectedCallback(){super.connectedCallback(),this._unsubStore=Be(()=>this.requestUpdate()),Le(this.hass)}disconnectedCallback(){super.disconnectedCallback(),this._unsubStore?.(),this._unsubStore=void 0,this._buttonFeedback.dispose()}_routines(){return Ve(this.roomKey)}_flashField(e,t){this._fieldFeedback={...this._fieldFeedback,[e]:t},window.setTimeout(()=>{if(this._fieldFeedback[e]!==t)return;const i={...this._fieldFeedback};delete i[e],this._fieldFeedback=i},2e3)}_btnFeedback(e){return this._feedbackVersion,this._buttonFeedback.get(e)}updated(e){if(super.updated(e),this._focusAddName&&this.shadowRoot&&(this._focusAddName=!1,requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".profile-add-name");e?.focus()})),!this._focusTarget||!this.shadowRoot)return;const{profileId:t,selector:i}=this._focusTarget,s=new Set(this._openProfileIds);s.add(t),this._openProfileIds=s,requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(i);e?.focus(),this._focusTarget=void 0})}_renderActionButton(e,t,i,s,o={}){const r=this._btnFeedback(e),n="success"===r?"mdi:check":"error"===r?"mdi:alert-circle-outline":i;return L`
      <button
        type="button"
          ...
          ${o?L`
                <div class="profile-temp">
                  <input
                    ...
                    step=${c}
                    .value=${h}
                    @change=${e=>{const t=parseFloat(e.target.value);Number.isNaN(t)||xe(this.hass,i,t)}}
                  />
    ...
    `:L`<div class="profile-hint">Preset entities loading… refresh in a moment.</div>`}async _copyProfile(e){const t=`copy-${e.profileId}`;try{const i=xt(this.hass,[e.room]);await wt(i),this._buttonFeedback.flash(t,"success",1500)}catch{this._buttonFeedback.flash(t,"error")}}async _pasteRoutine(e){const t=`paste-${e.profileId}`,i=await async function(){if(navigator.clipboard?.readText)try{const e=await navigator.clipboard.readText();if(e?.trim())return vt=e,e}catch{}return vt}();if(!i)return void this._buttonFeedback.flash(t,"error");const s=function(e){try{const t=JSON.parse(e);if((1===t?.version||2===t?.version)&&t?.type===gt&&t.rooms&&"object"==typeof t.rooms)return t}catch{}return null}(i);if(!s)return void this._buttonFeedback.flash(t,"error");const o=function(e,t,i,s,o){let r=0;for(const e of t){const t=i.rooms[e.name];if(!t)continue;void 0!==t.fanOverride&&ge(e.fanOverride)&&(o(e.fanOverride,t.fanOverride),r++);const n=[{key:"cooling",useId:e.useCooling,tempId:e.cooling,enabled:!0},{key:"heating",useId:e.useHeating,tempId:e.heating,enabled:!1!==e.has_heating},{key:"fan",useId:e.useFan,tempId:e.fan,enabled:!1!==e.has_fan}];for(const e of n){if(!e.enabled)continue;const i=$t("cooling"===e.key?t.cooling:"heating"===e.key?t.heating:t.fan);i&&(void 0!==i.use&&ge(e.useId)&&(o(e.useId,i.use),r++),void 0!==i.temp&&ge(e.tempId)&&(s(e.tempId,i.temp),r++))}}return r}(this.hass,[e.room],s,(e,t)=>xe(this.hass,e,t),(e,t)=>function(e,t,i){const s=t.split(".")[0];e.callService(s,i?"turn_on":"turn_off",{entity_id:t})}(this.hass,e,t));0!==o?this._buttonFeedback.flash(t,"success"):this._buttonFeedback.flash(t,"error")}async _copyCurrentRoom(){const e="copy-room";try{const t=await Pt(this.hass,this.config,this.roomKey);t&&this._showAddForm&&(this._pasteRoomSettingsOnCreate=!0),this._buttonFeedback.flash(e,t?"success":"error",1500)}catch{this._buttonFeedback.flash(e,"error")}}async _applyNow(e){const t=`apply-${e.profileId}`;this._busy=!0;try{await(i=this.hass,s=e.profileId,i.callWS({type:"room_climate_controller/profiles/apply",profile_id:s})),this._buttonFeedback.flash(t,"success")}catch{this._buttonFeedback.flash(t,"error")}finally{this._busy=!1}var i,s}_renameValue(e){return void 0!==this._renameDrafts[e.profileId]?this._renameDrafts[e.profileId]:Et(e.name,e.profileId)}_savedProfileName(e){return Et(e.name,e.profileId)}async _commitProfileName(e,t){const i=t.trim(),s=this._savedProfileName(e),o=`name-${e.profileId}`;if(i===s){const t={...this._renameDrafts};return delete t[e.profileId],void(this._renameDrafts=t)}if(!i){const t={...this._renameDrafts};return delete t[e.profileId],this._renameDrafts=t,void this._flashField(o,"error")}this._busy=!0;try{await function(e,t,i){return e.callWS({type:"room_climate_controller/profiles/rename",profile_id:t,name:i})}(this.hass,e.profileId,i);const t={...this._renameDrafts};delete t[e.profileId],this._renameDrafts=t,await Le(this.hass),this._flashField(o,"success")}catch{this._flashField(o,"error")}finally{this._busy=!1}}async _setProfileTime(e,t){const i=`time-${e.profileId}`;var s,o,r;if(Ot(this.hass,this.roomKey,e.profileId,t))this._flashField(i,"error");else if(ge(e.time))try{await(s=this.hass,o=e.time,r=`${t}:00`,"input_datetime"===o.split(".")[0]?s.callService("input_datetime","set_datetime",{entity_id:o,time:r}):s.callService("time","set_value",{entity_id:o,time:r})),await Le(this.hass),this._flashField(i,"success")}catch{this._flashField(i,"error")}}_timeConflictMessage(e){const t=Ot(this.hass,this.roomKey,"",e);if(!t)return"Another profile in this room already uses that time.";return`“${Et(t.name,t.profileId)}” already runs at ${e} in this room.`}async _addProfile(){const e="add-profile",t="add-profile-time",i=this._newProfileName.trim(),s=Nt(this._newProfileTime);if(this._addError="",!i)return this._addError="Enter a profile name.",void this._buttonFeedback.flash(e,"error");if(!s)return this._addError="Choose a valid time.",void this._flashField(t,"error");if(Ot(this.hass,this.roomKey,"",s))return this._addError=this._timeConflictMessage(s),void this._flashField(t,"error");this._busy=!0;try{const t=await(o=this.hass,r={name:i,room:this.roomKey,time:s,copy_room_settings:this._pasteRoomSettingsOnCreate},o.callWS({type:"room_climate_controller/profiles/create",...r}));await Le(this.hass),this._pasteRoomSettingsOnCreate=!1;const n=t.profile?.id;n&&(this._openProfileIds=new Set([...this._openProfileIds,n])),this._newProfileName="",this._newProfileTime=It(this.hass,this.roomKey),this._showAddForm=!1,this._addError="",this._buttonFeedback.flash(e,"success")}catch(t){this._addError=function(e){if(e&&"object"==typeof e&&"message"in e){const t=e.message;if("string"==typeof t)return t.trim()}return""}(t)||"Could not create profile. Check Settings → System → Logs.",this._buttonFeedback.flash(e,"error")}finally{this._busy=!1}var o,r}async _deleteProfile(e){const t=`delete-${e.profileId}`,i=Et(e.name,e.profileId);if(window.confirm(`Delete profile “${i}”?`)){this._busy=!0;try{await(s=this.hass,o=e.profileId,s.callWS({type:"room_climate_controller/profiles/delete",profile_id:o}));const i=new Set(this._openProfileIds);i.delete(e.profileId),this._openProfileIds=i,await Le(this.hass),this._buttonFeedback.flash(t,"success",800)}catch{this._buttonFeedback.flash(t,"error")}finally{this._busy=!1}var s,o}}_renderProfile(e){const t=ge(e.time)?we(this.hass.states[e.time]?.state):"",i=Et(e.name,e.profileId),s=function(e,t){const i=we(e.states[t.time]?.state);return!!i&&Boolean(Ot(e,t.roomKey,t.profileId,i))}(this.hass,e),o=`time-${e.profileId}`,r=`name-${e.profileId}`;return L`
      <details
        class="profile-item"
      ...
      <div class="profiles-toolbar">
        ...
        ${this._showAddForm?L`
              ...
              <button
                ...
                ?disabled=${this._busy}
                @click=${()=>{this._showAddForm=!1,this._newProfileName="",this._newProfileTime=It(this.hass,this.roomKey),this._addError="",this._pasteRoomSettingsOnCreate=!1}}
              >
                <span>Cancel</span>
              </button>
            ...
            `:L`
              <button
                ...
                class="rcc-btn profile-action-btn"
                ?disabled=${this._busy}
                @click=${()=>{this._newProfileName="",this._newProfileTime=It(this.hass,this.roomKey),this._addError="",this._pasteRoomSettingsOnCreate=!1,this._showAddForm=!0,this._focusAddName=!0}}
              >
    ...
    `}render(){const e=this._routines(),t=e.filter(St);return L`
      <details
    ...
    `}static get styles(){return Tt}};e([pe({attribute:!1})],Rt.prototype,"hass",void 0),e([pe({attribute:!1})],Rt.prototype,"config",void 0),e([pe({attribute:!1})],Rt.prototype,"roomKey",void 0),e([ue()],Rt.prototype,"_profilesOpen",void 0),e([ue()],Rt.prototype,"_busy",void 0),e([ue()],Rt.prototype,"_newProfileName",void 0),e([ue()],Rt.prototype,"_newProfileTime",void 0),e([ue()],Rt.prototype,"_showAddForm",void 0),e([ue()],Rt.prototype,"_addError",void 0),e([ue()],Rt.prototype,"_renameDrafts",void 0),e([ue()],Rt.prototype,"_feedbackVersion",void 0),e([ue()],Rt.prototype,"_fieldFeedback",void 0),e([ue()],Rt.prototype,"_openProfileIds",void 0),e([ue()],Rt.prototype,"_focusTarget",void 0),e([ue()],Rt.prototype,"_focusAddName",void 0),e([ue()],Rt.prototype,"_pasteRoomSettingsOnCreate",void 0),Rt=e([ce("room-climate-profiles-panel")],Rt),window.customCards=window.customCards||[],window.customCards.push({type:"room-climate-control",name:"Room Climate Control",description:"Per-room climate dashboard card wired to a room's backend helpers and devices.",preview:!0}),console.info("%c ROOM-CLIMATE-CONTROL %c v1.4.12 ","color: white; background: #0288d1; font-weight: 700;","color: #0288d1; background: white; font-weight: 700;");
