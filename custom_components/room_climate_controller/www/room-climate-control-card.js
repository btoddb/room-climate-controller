 ...
 */function fe(e){return pe({...e,state:!0,attribute:!1})}const ue="sensor.outdoor_temperature";function me(e,t,i,o){if(!e)return null;const s="fan"===o?'(\n    (state && state.state) ||\n    y\n  ) === "off" ? 0 : 1':function(e){return`(\n    (state && state.attributes && state.attributes.hvac_mode) ||\n    (state && state.state) ||\n    y\n  ) === "${"cooling"===e?"cool":"heat"}" ? 1 : 0`}(o);return{entity:e,filters:[{map_y:s}],name:`$ex '${t}: ' + (Number(ys.at(-1)) === 1 ? 'On' : Number(ys.at(-1)) === 0 ? 'Off' : '—')`,hovertemplate:"%{x|%H:%M}: %{y}<extra></extra>",yaxis:"y2",visible:`$ex hass.states['${e}'] !== undefined`,line:{shape:"hv",color:i,width:1.5}}}function _e(e){return Boolean(e&&e.trim())}function ge(e,t,i="—"){if(!_e(t)||!e.states[t])return i;const o=e.states[t];if("unavailable"===o.state||"unknown"===o.state)return i;const s=o.attributes.unit_of_measurement||"",r=parseFloat(o.state);return Number.isNaN(r)?e.formatEntityState(o):`${Number.isInteger(r)?r:r.toFixed(1)}${s?` ${s}`:""}`}function ve(e,t){if(!_e(t)||!e.states[t])return"—";const i=e.states[t].state;if("unavailable"===i||"unknown"===i)return"—";const o=Math.round(parseFloat(i));return Number.isNaN(o)?"—":`${o} W now`}function ye(e,t){const i=e.states[t];if(!i)return"—";const o=i.attributes.hvac_mode||i.state;return o?o.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase()):"—"}function be(e,t){const i=e.states[t];if(!i)return;const o=parseFloat(i.state);return Number.isNaN(o)?void 0:Math.round(o)}function $e(e,t,i){const o=t.split(".")[0];e.callService(o,"set_value",{entity_id:t,value:i})}function xe(e){if(!e||"unknown"===e||"unavailable"===e)return"";const t=e.split(":");return t.length>=2?`${t[0].padStart(2,"0")}:${t[1].padStart(2,"0")}`:e}function we(e,t){e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}async function Ae(e,t){if(!await async function(e,t=15e3){if(customElements.get(e))return!0;try{return await Promise.race([customElements.whenDefined(e),new Promise((i,o)=>{setTimeout(()=>o(new Error(`Timed out waiting for ${e}`)),t)})]),!0}catch{return!1}}("plotly-graph"))return null;const{type:i,...o}=t,s=document.createElement("plotly-graph");return s.setConfig(o),s.hass=e,s}function Ee(e,t){return e.states[t]}function ke(e,t,i=0){const o=parseFloat(e.states[t]?.state??"");return Number.isNaN(o)?i:o}function Ce(e,t,i,o){if(!_e(t)||!_e(i))return null;const s=ke(e,t),r=ke(e,i,1);return o?s-r:s+r}function Se(e,t,i,o){const s=Ee(e,t);if(!s)return K;const r=Number(s.attributes.min??1),n=Number(s.attributes.max??20),a=Number(s.attributes.step??1),l=ke(e,t,r);return L`
  ...
  `}function Ne(e,t,i){const o=Boolean(t.subtractOffsets),s=Ce(e,t.target,t.mediumOffset,o),r=Ce(e,t.target,t.highOffset,o);return L`
...
`;function Fe(e){return e.callWS({type:"room_climate_controller/rooms/list"})}function Re(e){return e.callWS({type:"room_climate_controller/profiles/list"})}function Me(e){if(e&&"object"==typeof e&&"message"in e){const t=e.message;if("string"==typeof t)return t.trim()}return""}let Te=[],De=[],He=!1,Ue=null;const ze=new Set;function je(e){return ze.add(e),()=>ze.delete(e)}async function Be(e){return Ue||(Ue=(async()=>{try{const[t,i]=await Promise.all([Fe(e),Re(e)]);Te=t.rooms??[],De=i.profiles??[],He=!0,function(){for(const e of ze)e()}()}catch{}finally{Ue=null}})(),Ue)}function Le(){return Te}function Ge(e){return Te.find(t=>t.key===e)}function Ke(){return Te.map(e=>({key:e.key,label:e.label,has_heating:e.has_heating,has_fan:e.has_fan}))}function We(e){const t=e.entities.presets??{},i={name:Ge(e.room)?.label??e.room,roomKey:e.room,has_heating:e.has_heating,has_fan:e.has_fan,useCooling:t.cooling?.use_entity??void 0,useHeating:t.heating?.use_entity??void 0,useFan:t.fan?.use_entity??void 0,fanOverride:e.entities.fan_override??void 0,fanReverse:e.entities.fan_reverse??void 0,cooling:t.cooling?.temp_entity??"",heating:t.heating?.temp_entity??void 0,fan:t.fan?.temp_entity??void 0};return{profileId:e.id,name:e.name,enabled:e.entities.enabled??"",time:e.entities.time??"",roomKey:e.room,room:i}}function qe(e){return De.filter(t=>t.room===e).map(We).sort((e,t)=>{const i=Ve(e.profileId),o=Ve(t.profileId);return i!==o?i.localeCompare(o):e.profileId.localeCompare(t.profileId,void 0,{numeric:!0})})}function Ve(e){return De.find(t=>t.id===e)?.time??"99:99"}const Je={use:null,target:null,medium_offset:null,high_offset:null};function Ze(e){return e.room?.trim()||e.profile_room_key?.trim()||void 0}function Ye(e){const t=Ze(e);if(!t)return;const i=Ge(t);if(!i)return;const o=i.entities,s=e=>o.live[e]??Je,r=s("cooling"),n=s("heating"),a=s("fan");return function(e={}){return{type:"custom:room-climate-control",room_name:"Room",temp_sensor:"",use_ac:"",use_heater:"",use_fan:"",manual_mode:"",target_cooling:"",cooling_medium_offset:"",cooling_high_offset:"",target_heating:"",heating_medium_offset:"",heating_high_offset:"",target_fan:"",fan_medium_offset:"",fan_high_offset:"",outdoor_sensor:ue,time_range:"",...e}}({type:"custom:room-climate-control",room:t,profile_room_key:t,room_name:i.label,temp_sensor:o.temperature??"",humidity_sensor:o.humidity??"",power_sensor:o.power??"",ac_entity:o.ac_entity??"",heater_entity:o.heater_entity??"",fan_entity:o.fan_entity??"",window_sensors:o.window_sensors??[],manual_mode:o.manual_mode??"",ac_fan_only_override:o.ac_fan_only_override??"",heater_fan_only_override:o.heater_fan_only_override??"",fan_reversible:i.fan_reversible??!1,fan_reverse_toggle:o.fan_reverse??"",use_ac:r.use??"",target_cooling:r.target??"",cooling_medium_offset:r.medium_offset??"",cooling_high_offset:r.high_offset??"",use_heater:n.use??"",target_heating:n.target??"",heating_medium_offset:n.medium_offset??"",heating_high_offset:n.high_offset??"",use_fan:a.use??"",target_fan:a.target??"",fan_medium_offset:a.medium_offset??"",fan_high_offset:a.high_offset??"",outdoor_sensor:e.outdoor_sensor??o.outdoor??ue,time_range:e.time_range??o.time_range??"",ac_device_button:o.ac_device_button??e.ac_device_button,heater_device_button:o.heater_device_button??e.heater_device_button,fan_device_button:o.fan_device_button??e.fan_device_button})}let Xe=class extends ae{constructor(){super(...arguments),this._settingsOpen=!1,this._graphDialog=null,this._graphOverlay=new Oe}setConfig(e){if(this._userConfig=e,!Ze(e))return this._config=void 0,void(this._configError="Select a room in the card editor.");this._configError=void 0,this._resolveRoom()}_resolveRoom(){const e=Ye(this._userConfig);if(e)return this._config=e,void(this._configError=void 0);const t=Ze(this._userConfig);Le().length>0&&t&&!function(e){return Le().some(t=>t.key===e)}(t)&&(this._config=void 0,this._configError=`Unknown room "${t}". Add it in the Room Climate integration.`)}getCardSize(){return 6}static getConfigElement(){return document.createElement("room-climate-control-editor")}static getStubConfig(){const e=Le()[0]?.key;return{type:"custom:room-climate-control",room:e??""}}connectedCallback(){super.connectedCallback(),Be(this.hass),this._unsubRooms??=je(()=>{this._resolveRoom(),this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._graphOverlay.close(),this._unsubRooms?.(),this._unsubRooms=void 0}updated(e){if(!(e.has("hass")&&this._graphDialog&&this.hass&&this._config))return;this._overlayGraphEl&&(this._overlayGraphEl.hass=this.hass),this._overlayPowerNowEl&&_e(this._config.power_sensor)&&(this._overlayPowerNowEl.textContent=ve(this.hass,this._config.power_sensor));const t=this._config.time_range||"",i=this.hass.states[t]?.state;i&&i!==this._lastGraphHours&&(this._lastGraphHours=i,this._mountGraphOverlay())}render(){if(!this.hass)return L``;if(this._configError)return L`
    ...
    `}_renderProfilesPanel(e){const t=function(e){const t=e.profile_room_key?.trim();if(t)return t;const i=e.manual_mode?.trim();if(i){const e=Le().find(e=>e.entities.manual_mode===i);if(e)return e.key}const o=e.manual_mode?.match(/^input_boolean\.([a-z0-9_]+)_climate_manual_mode$/);return o&&Le().some(e=>e.key===o[1])?o[1]:void 0}(e);return t?L`
      <room-climate-profiles-panel
        ...
        .roomKey=${t}
      ></room-climate-profiles-panel>
    `:K}_renderDevicesPanel(e){const t=[],i=(o=this.hass,(e.window_sensors??[]).some(e=>_e(e)&&"on"===o.states[e]?.state));var o;const s=(i,o,s,r,n,a,l,c,d=!1)=>{if(!_e(s)||!function(e,t){if(!_e(t))return!1;const i=e.states[t];return!!i&&"unavailable"!==i.state&&"unknown"!==i.state}(this.hass,s))return;const h=Ee(this.hass,r);if(!h)return;const p=s,f=function(e,t,i=72){return be(e,t)??i}(this.hass,n),u="cooling"===o&&_e(e.heater_entity)?be(this.hass,e.target_heating):"heating"===o&&_e(e.ac_entity)?be(this.hass,e.target_cooling):void 0,{min:m,max:_}=function(e,t,i,o){const s={...t};return void 0!==o&&Number.isFinite(o)&&("cooling"===e||"fan"===e?s.max=Math.min(s.max,t.max-o):"heating"===e&&(s.min=Math.max(s.min,t.min+o))),void 0!==i&&Number.isFinite(i)?"cooling"===e?{...s,min:Math.max(s.min,i+1)}:"heating"===e?{...s,max:Math.min(s.max,i-1)}:s:s}(o,function(e,t){const i=e.states[t]?.attributes??{},o=Number(i.min??i.native_min_value),s=Number(i.max??i.native_max_value);return{min:Number.isFinite(o)?o:-1/0,max:Number.isFinite(s)?s:1/0}}(this.hass,n),u,be(this.hass,a)),g=l(this.hass,p),v=e=>{const t=Math.min(_,Math.max(m,f+e));t!==f&&$e(this.hass,n,t)},y=_e(c),b=y?Ee(this.hass,c):void 0;t.push(L`
      ...
      `)},r=_e(e.ac_entity)&&_e(e.heater_entity)&&e.ac_entity===e.heater_entity;if(s("Cooling","cooling",e.ac_entity,e.use_ac,e.target_cooling,e.cooling_high_offset,ye,e.ac_fan_only_override,i),s("Heating","heating",e.heater_entity,e.use_heater,e.target_heating,e.heating_high_offset,ye,r?void 0:e.heater_fan_only_override,i),s("Fan","fan",e.fan_entity,e.use_fan,e.target_fan,e.fan_high_offset,(t,i)=>function(e,t,i=!1){const o=e.states[t];if(!o)return"—";if("off"===o.state)return"Off";const s=o.attributes.direction,r=o.attributes.preset_mode;let n="";"forward"===s||"reverse"===s?n="reverse"===s?" (Reverse)":" (Forward)":i&&null!=r&&(n="reverse"===r?" (Reverse)":" (Forward)");const a=o.attributes.percentage;return null!=a?`${a}%${n}`:o.state?o.state.replace(/\b\w/g,e=>e.toUpperCase())+n:"—"}(t,i,e.fan_reversible??!1)),0===t.length)return K;(e.window_sensors??[]).length>0&&t.unshift(L`
