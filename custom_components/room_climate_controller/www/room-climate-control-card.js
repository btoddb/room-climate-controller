    ...
    <div class="settings-row">
      ...
      <div class="settings-row-control settings-slider-control">
        <input
          ...
          step=${a}
          .value=${String(l)}
          @input=${i=>{const s=parseFloat(i.target.value);Number.isNaN(s)||be(e,t,s)}}
        />
        <span class="settings-offset-value">${l}°F</span>
      </div>
    </div>
  `}function Ce(e,t,i){const s=Boolean(t.subtractOffsets),o=ke(e,t.target,t.mediumOffset,s),r=ke(e,t.target,t.highOffset,s);return L`
    <div class="settings-section">
      <div class="settings-section-title">${t.title}</div>
      ${function(e,t,i){const s=Ae(e,t);if(!s)return K;const o=Number(s.attributes.min??0),r=Number(s.attributes.max??100),n=Number(s.attributes.step??1),a=Ee(e,t);return L`
    <div class="settings-row">
      <span class="settings-row-label">${i}</span>
      <div class="settings-row-control settings-target-control">
        <input
          ...
          step=${n}
          .value=${String(a)}
          @change=${i=>{const s=parseFloat(i.target.value);Number.isNaN(s)||be(e,t,s)}}
        />
        <span class="settings-unit">°F</span>
      </div>
    </div>
  `}(e,t.target,"Target")}
      ${Se(e,t.mediumOffset,"Medium offset",o)}
      ${Se(e,t.highOffset,"High offset",r)}
      ${function(e,t){if(!t)return K;const i=Ae(e,t);if(!i)return K;const s=i.attributes.options??[];if(s.length<=1)return K;const o=i.state??"Auto";return L`
    <div class="settings-row">
      ...
      <div class="settings-row-control">
        <select
          ...
          .value=${o}
          @change=${i=>{const s=i.target.value;e.callService("select","select_option",{entity_id:t,option:s})}}
        >
          ${s.map(e=>L`<option value=${e} ?selected=${e===o}>${e}</option>`)}
        </select>
      </div>
    </div>
  `}(e,t.presetSelect)}
...
`;function Ie(e){return e.callWS({type:"room_climate_controller/rooms/list"})}function Fe(e){return e.callWS({type:"room_climate_controller/profiles/list"})}function Re(e){if(e&&"object"==typeof e&&"message"in e){const t=e.message;if("string"==typeof t)return t.trim()}return""}let Te=[],Me=[],De=!1,Ue=null;const He=new Set;function ze(e){return He.add(e),()=>He.delete(e)}async function je(e){return Ue||(Ue=(async()=>{try{const[t,i]=await Promise.all([Ie(e),Fe(e)]);Te=t.rooms??[],Me=i.profiles??[],De=!0,function(){for(const e of He)e()}()}catch{}finally{Ue=null}})(),Ue)}function Be(){return Te}function Le(e){return Te.find(t=>t.key===e)}function Ge(){return Te.map(e=>({key:e.key,label:e.label,has_heating:e.has_heating,has_fan:e.has_fan}))}function Ke(e){const t=e.entities.presets??{},i={name:Le(e.room)?.label??e.room,roomKey:e.room,has_heating:e.has_heating,has_fan:e.has_fan,useCooling:t.cooling?.use_entity??void 0,useHeating:t.heating?.use_entity??void 0,useFan:t.fan?.use_entity??void 0,fanOverride:e.entities.fan_override??void 0,fanReverse:e.entities.fan_reverse??void 0,fanPreset:e.entities.fan_preset??void 0,cooling:t.cooling?.temp_entity??"",heating:t.heating?.temp_entity??void 0,fan:t.fan?.temp_entity??void 0};return{profileId:e.id,name:e.name,enabled:e.entities.enabled??"",time:e.entities.time??"",roomKey:e.room,room:i}}function We(e){return Me.filter(t=>t.room===e).map(Ke).sort((e,t)=>{const i=qe(e.profileId),s=qe(t.profileId);return i!==s?i.localeCompare(s):e.profileId.localeCompare(t.profileId,void 0,{numeric:!0})})}function qe(e){return Me.find(t=>t.id===e)?.time??"99:99"}const Ve={use:null,target:null,medium_offset:null,high_offset:null};function Je(e){return e.room?.trim()||e.profile_room_key?.trim()||void 0}function Ze(e){const t=Je(e);if(!t)return;const i=Le(t);if(!i)return;const s=i.entities,o=e=>s.live[e]??Ve,r=o("cooling"),n=o("heating"),a=o("fan");return function(e={}){return{type:"custom:room-climate-control",room_name:"Room",temp_sensor:"",use_ac:"",use_heater:"",use_fan:"",manual_mode:"",target_cooling:"",cooling_medium_offset:"",cooling_high_offset:"",target_heating:"",heating_medium_offset:"",heating_high_offset:"",target_fan:"",fan_medium_offset:"",fan_high_offset:"",outdoor_sensor:ue,time_range:"",...e}}({type:"custom:room-climate-control",room:t,profile_room_key:t,room_name:i.label,temp_sensor:s.temperature??"",humidity_sensor:s.humidity??"",power_sensor:s.power??"",ac_entity:s.ac_entity??"",heater_entity:s.heater_entity??"",fan_entity:s.fan_entity??"",window_sensors:s.window_sensors??[],manual_mode:s.manual_mode??"",ac_fan_only_override:s.ac_fan_only_override??"",heater_fan_only_override:s.heater_fan_only_override??"",fan_reversible:i.fan_reversible??!1,fan_reverse_toggle:s.fan_reverse??"",fan_preset_select:s.fan_preset_select??"",use_ac:r.use??"",target_cooling:r.target??"",cooling_medium_offset:r.medium_offset??"",cooling_high_offset:r.high_offset??"",use_heater:n.use??"",target_heating:n.target??"",heating_medium_offset:n.medium_offset??"",heating_high_offset:n.high_offset??"",use_fan:a.use??"",target_fan:a.target??"",fan_medium_offset:a.medium_offset??"",fan_high_offset:a.high_offset??"",outdoor_sensor:e.outdoor_sensor??s.outdoor??ue,time_range:e.time_range??s.time_range??"",ac_device_button:s.ac_device_button??e.ac_device_button,heater_device_button:s.heater_device_button??e.heater_device_button,fan_device_button:s.fan_device_button??e.fan_device_button})}let Ye=class extends ae{constructor(){super(...arguments),this._settingsOpen=!1,this._graphDialog=null,this._graphOverlay=new Ne}setConfig(e){if(this._userConfig=e,!Je(e))return this._config=void 0,void(this._configError="Select a room in the card editor.");this._configError=void 0,this._resolveRoom()}_resolveRoom(){const e=Ze(this._userConfig);if(e)return this._config=e,void(this._configError=void 0);const t=Je(this._userConfig);Be().length>0&&t&&!function(e){return Be().some(t=>t.key===e)}(t)&&(this._config=void 0,this._configError=`Unknown room "${t}". Add it in the Room Climate integration.`)}getCardSize(){return 6}static getConfigElement(){return document.createElement("room-climate-control-editor")}static getStubConfig(){const e=Be()[0]?.key;return{type:"custom:room-climate-control",room:e??""}}connectedCallback(){super.connectedCallback(),je(this.hass),this._unsubRooms??=ze(()=>{this._resolveRoom(),this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._graphOverlay.close(),this._unsubRooms?.(),this._unsubRooms=void 0}updated(e){if(!(e.has("hass")&&this._graphDialog&&this.hass&&this._config))return;this._overlayGraphEl&&(this._overlayGraphEl.hass=this.hass),this._overlayPowerNowEl&&_e(this._config.power_sensor)&&(this._overlayPowerNowEl.textContent=ve(this.hass,this._config.power_sensor));const t=this._config.time_range||"",i=this.hass.states[t]?.state;i&&i!==this._lastGraphHours&&(this._lastGraphHours=i,this._mountGraphOverlay())}render(){if(!this.hass)return L``;if(this._configError)return L`
        <ha-card>
    ...
    `}_renderProfilesPanel(e){const t=function(e){const t=e.profile_room_key?.trim();if(t)return t;const i=e.manual_mode?.trim();if(i){const e=Be().find(e=>e.entities.manual_mode===i);if(e)return e.key}const s=e.manual_mode?.match(/^input_boolean\.([a-z0-9_]+)_climate_manual_mode$/);return s&&Be().some(e=>e.key===s[1])?s[1]:void 0}(e);return t?L`
      <room-climate-profiles-panel
        .hass=${this.hass}
        .config=${e}
        .roomKey=${t}
      ></room-climate-profiles-panel>
    `:K}_renderDevicesPanel(e){const t=[],i=(s=this.hass,(e.window_sensors??[]).some(e=>_e(e)&&"on"===s.states[e]?.state));var s;const o=(e,i,s,o,r,n,a=!1)=>{if(!_e(i)||!function(e,t){if(!_e(t))return!1;const i=e.states[t];return!!i&&"unavailable"!==i.state&&"unknown"!==i.state}(this.hass,i))return;const l=Ae(this.hass,s);if(!l)return;const c=i,d=function(e,t,i=72){const s=e.states[t];if(!s)return i;const o=parseFloat(s.state);return Number.isNaN(o)?i:Math.round(o)}(this.hass,o),h=r(this.hass,c),p=_e(n),f=p?Ae(this.hass,n):void 0;t.push(L`
      ...
      `)},r=_e(e.ac_entity)&&_e(e.heater_entity)&&e.ac_entity===e.heater_entity;if(o("Cooling",e.ac_entity,e.use_ac,e.target_cooling,ye,e.ac_fan_only_override,i),o("Heating",e.heater_entity,e.use_heater,e.target_heating,ye,r?void 0:e.heater_fan_only_override,i),o("Fan",e.fan_entity,e.use_fan,e.target_fan,(t,i)=>function(e,t,i=!1,s){const o=e.states[t];if(!o)return"—";if("off"===o.state)return"Off";let r="";const n=s?e.states[s]?.state:void 0;if(n&&"Auto"!==n)r=` (${n.charAt(0).toUpperCase()+n.slice(1)})`;else{const e=o.attributes.direction,t=o.attributes.preset_mode;"forward"===e||"reverse"===e?r="reverse"===e?" (Reverse)":" (Forward)":i&&null!=t&&(r="reverse"===t?" (Reverse)":" (Forward)")}const a=o.attributes.percentage;return null!=a?`${a}%${r}`:o.state?o.state.replace(/\b\w/g,e=>e.toUpperCase())+r:"—"}(t,i,e.fan_reversible??!1,e.fan_preset_select)),0===t.length)return K;(e.window_sensors??[]).length>0&&t.unshift(L`
  ...
  `}(this.hass,this._config)}
    ...
    `}_onSettingsDeviceButton(e,t){t.disabled||(t.disabled=!0,async function(e,t){const i=t.action;if("perform-action"!==i&&"call-service"!==i)return;const s=t.perform_action??t.service;if(!s?.includes("."))return;const[o,r]=s.split(".",2),n={...t.data??{}},a=t.target;void 0!==a?.entity_id&&(n.entity_id=a.entity_id),await e.callService(o,r,n)}(this.hass,e.tap_action).finally(()=>{window.setTimeout(()=>{t.disabled=!1},1e3)}))}_openSettings(){this._closeGraphDialog(),this._settingsOpen=!0}_closeSettings(){this._settingsOpen=!1}_openGraphDialog(e){this._config&&(this._closeSettings(),this._graphDialog=e,this._lastGraphHours=this.hass.states[this._config.time_range||""]?.state,this._mountGraphOverlay())}_closeGraphDialog(){this._graphOverlay.isOpen?this._graphOverlay.close():this._clearGraphDialogState()}_clearGraphDialogState(){this._graphDialog=null,this._lastGraphHours=void 0,this._overlayGraphEl=void 0,this._overlayPowerNowEl=void 0}async _mountGraphOverlay(){if(!this._graphDialog||!this.hass||!this._config)return;const e=this._config,t={energy:`${e.room_name} · Energy Use`,history:`${e.room_name} · History`},i=this._graphOverlay.open(t[this._graphDialog],()=>{this._clearGraphDialogState()});i.innerHTML="",this._overlayGraphEl=void 0,this._overlayPowerNowEl=void 0;const s=e.time_range||"",o=parseInt(this.hass.states[s]?.state||"24",10)||24;if(s){const e=await async function(e,t){if(!window.loadCardHelpers)return null;const i=await window.loadCardHelpers(),s=await i.createCardElement(t);return s&&(s.hass=e),s}(this.hass,function(e){return{type:"entities",entities:[{entity:e,name:"Time range (hours)"}]}}(s));e&&i.appendChild(e)}if("energy"===this._graphDialog){if(_e(e.power_sensor)){const t=document.createElement("div");t.className="rcc-overlay-power-now",t.textContent=ve(this.hass,e.power_sensor),i.appendChild(t),this._overlayPowerNowEl=t}const t=document.createElement("div");t.className="rcc-overlay-graph-host",i.appendChild(t);const r=await we(this.hass,function(e,t){return{type:"custom:plotly-graph",hours_to_show:t,refresh_interval:60,config:{displayModeBar:!1,scrollZoom:!1},entities:[{entity:e.power_sensor,filters:["force_numeric"],name:"$ex 'Power: ' + (ys.at(-1) != null ? Math.round(ys.at(-1)) + ' W' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.0f} W<extra></extra>",line:{color:"rgb(255,165,0)",width:2}}],layout:{dragmode:!1,height:400,legend:{orientation:"h",yanchor:"bottom",y:1.02,xanchor:"center",x:.5},margin:{t:40,r:20},yaxis:{title:"Watts",showgrid:!1,zeroline:!1,rangemode:"tozero",fixedrange:!0},xaxis:{showgrid:!1,fixedrange:!0}}}}(e,o));return r?(t.appendChild(r),this._overlayGraphEl=r):t.textContent="Unable to load energy graph (plotly-graph unavailable).",void(this._lastGraphHours=this.hass.states[s]?.state)}const r=document.createElement("div");r.className="rcc-overlay-graph-host",i.appendChild(r);const n=await we(this.hass,function(e,t){const i=e.outdoor_sensor||ue,s=[{entity:e.temp_sensor,filters:["force_numeric",{fn:"({ xs, ys, vars }) => {\n            vars._roomTempVals = ys.map(Number).filter((n) => !isNaN(n));\n            return { xs, ys };\n          }"}],name:"$ex 'Room: ' + (ys.at(-1) != null ? ys.at(-1).toFixed(1) + ' °F' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.1f} °F<extra></extra>",yaxis:"y",line:{color:"rgb(255,165,0)",width:2}},{entity:i,filters:["force_numeric",{fn:"({ xs, ys, vars }) => {\n            const outdoor = ys.map(Number).filter((n) => !isNaN(n));\n            const all = [...(vars._roomTempVals || []), ...outdoor];\n            if (all.length) {\n              const dmin = Math.min(...all);\n              const dmax = Math.max(...all);\n              vars.tempYRange = [Math.min(20, dmin) - 1, Math.max(100, dmax) + 1];\n            } else {\n              vars.tempYRange = [20, 100];\n            }\n            return { xs, ys };\n          }"}],name:"$ex 'Outdoor: ' + (ys.at(-1) != null ? ys.at(-1).toFixed(1) + ' °F' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.1f} °F<extra></extra>",yaxis:"y",line:{color:"rgb(100,180,255)",width:2}}],o=me(e.ac_entity,"Cooling","rgb(30,144,255)","cooling"),r=me(e.heater_entity,"Heating","rgb(220,60,60)","heating"),n=me(e.fan_entity,"Fan","rgb(0,180,160)","fan");return o&&s.push(o),r&&s.push(r),n&&s.push(n),{type:"custom:plotly-graph",hours_to_show:t,refresh_interval:60,config:{displayModeBar:!1,scrollZoom:!1},entities:s,layout:{dragmode:!1,height:400,legend:{orientation:"h",yanchor:"bottom",y:1.02,xanchor:"center",x:.5},margin:{t:0,r:60},yaxis:{title:"°F",showgrid:!1,zeroline:!1,range:"$ex vars.tempYRange || [20, 100]",autorange:!1,fixedrange:!0},yaxis2:{title:"State",showgrid:!1,zeroline:!1,overlaying:"y",side:"right",range:[0,1.2],autorange:!1,fixedrange:!0,tickvals:[0,1],ticktext:["Off","On"]},xaxis:{showgrid:!1,fixedrange:!0}}}}(e,o));n?(r.appendChild(n),this._overlayGraphEl=n):r.textContent="Unable to load history graph (plotly-graph unavailable).",this._lastGraphHours=this.hass.states[s]?.state}static get styles(){return Oe}};e([pe({attribute:!1})],Ye.prototype,"hass",void 0),e([fe()],Ye.prototype,"_config",void 0),e([fe()],Ye.prototype,"_configError",void 0),e([fe()],Ye.prototype,"_settingsOpen",void 0),e([fe()],Ye.prototype,"_graphDialog",void 0),Ye=e([ce("room-climate-control")],Ye);const Xe={room:"Room",outdoor_sensor:"Outdoor temperature sensor",time_range:"Graph time-range helper",ac_device_button:"A/C lights & sound button (tap_action)",heater_device_button:"Heater lights & sound button (tap_action)",fan_device_button:"Fan lights & sound button (tap_action)"},Qe=["outdoor_sensor","time_range"],et=[{name:"outdoor_sensor",selector:{entity:{filter:[{domain:"sensor",device_class:"temperature"}]}}},{name:"time_range",selector:{entity:{filter:[{domain:"select"},{domain:"input_select"}]}}}];let tt=class extends ae{constructor(){super(...arguments),this._schemaKey="",this._computeLabel=e=>Xe[e.name]||e.name}setConfig(e){this._config={...e,type:"custom:room-climate-control"}}connectedCallback(){super.connectedCallback(),this.hass&&je(this.hass),this._unsub??=ze(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=void 0}_getSchema(e){const t=e.map(e=>e.key).join(",");return this._schema&&t===this._schemaKey||(this._schema=function(e){return[{name:"room",required:!0,selector:{select:{mode:"dropdown",options:e.map(e=>({value:e.key,label:e.label}))}}},...et]}(e),this._schemaKey=t),this._schema}render(){if(!this.hass||!this._config)return L``;const e=Ge(),t=Le(this._config.room??"")?.entities,i=function(e,t={}){return{room:e.room??"",outdoor_sensor:e.outdoor_sensor??t.outdoor_sensor??"",time_range:e.time_range??t.time_range??""}}(this._config,{outdoor_sensor:t?.outdoor,time_range:t?.time_range});return L`
      ...
      ></ha-form>
    `}_valueChanged(e){e.stopPropagation();const t=e.detail.value,i={...this._config,...t,type:"custom:room-climate-control"},s=i;for(const e of Qe){const t=s[e];(null==t||""===t||"object"==typeof t&&0===Object.keys(t).length)&&delete s[e]}var o,r;this._config=i,o=this,r=this._config,o.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:r}}))}static get styles(){return n`
      :host {
        display: block;
        padding: 16px;
      }
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const it=2;let st=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:ot}=oe,rt=e=>e,nt=()=>document.createComment(""),at=(e,t,i)=>{const s=e._$AA.parentNode,o=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(nt(),o),r=s.insertBefore(nt(),o);i=new ot(t,r,e,e.options)}else{const t=i._$AB.nextSibling,r=i._$AM,n=r!==e;if(n){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==r._$AU&&i._$AP(t)}if(t!==o||n){let e=i._$AA;for(;e!==t;){const t=rt(e).nextSibling;rt(s).insertBefore(e,o),e=t}}}return i},lt=(e,t,i=e)=>(e._$AI(t,i),e),ct={},dt=(e,t=ct)=>e._$AH=t,ht=e=>{e._$AR(),e._$AA.remove()},pt=(e,t,i)=>{const s=new Map;for(let o=t;o<=i;o++)s.set(e[o],o);return s},ft=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends st{constructor(e){if(super(e),e.type!==it)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let s;void 0===i?i=t:void 0!==t&&(s=t);const o=[],r=[];let n=0;for(const t of e)o[n]=s?s(t,n):n,r[n]=i(t,n),n++;return{values:r,keys:o}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,s]){const o=(e=>e._$AH)(e),{values:r,keys:n}=this.dt(t,i,s);if(!Array.isArray(o))return this.ut=n,r;const a=this.ut??=[],l=[];let c,d,h=0,p=o.length-1,f=0,u=r.length-1;for(;h<=p&&f<=u;)if(null===o[h])h++;else if(null===o[p])p--;else if(a[h]===n[f])l[f]=lt(o[h],r[f]),h++,f++;else if(a[p]===n[u])l[u]=lt(o[p],r[u]),p--,u--;else if(a[h]===n[u])l[u]=lt(o[h],r[u]),at(e,l[u+1],o[h]),h++,u--;else if(a[p]===n[f])l[f]=lt(o[p],r[f]),at(e,o[h],o[p]),p--,f++;else if(void 0===c&&(c=pt(n,f,u),d=pt(a,h,p)),c.has(a[h]))if(c.has(a[p])){const t=d.get(n[f]),i=void 0!==t?o[t]:null;if(null===i){const t=at(e,o[h]);lt(t,r[f]),l[f]=t}else l[f]=lt(i,r[f]),at(e,o[h],i),o[t]=null;f++}else ht(o[p]),p--;else ht(o[h]),h++;for(;f<=u;){const t=at(e,l[u+1]);lt(t,r[f]),l[f++]=t}for(;h<=p;){const e=o[h++];null!==e&&ht(e)}return this.ut=n,dt(e,l),G}}),ut="daily-routine-climate-temps";
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let mt=null;function _t(e,t){if(!_e(t))return;const i=parseFloat(e.states[t]?.state??"");return Number.isNaN(i)?void 0:Math.round(i)}function gt(e,t){if(!_e(t))return;const i=e.states[t]?.state;return"on"===i||"off"!==i&&void 0}function vt(e){if(void 0!==e)return"number"==typeof e?{temp:e}:e}function yt(e,t){const i={};for(const s of t){const t={},o=_t(e,s.cooling),r=gt(e,s.useCooling);if(void 0===o&&void 0===r||(t.cooling={temp:o,use:r}),!1!==s.has_heating){const i=_t(e,s.heating),o=gt(e,s.useHeating);void 0===i&&void 0===o||(t.heating={temp:i,use:o})}if(!1!==s.has_fan){const i=_t(e,s.fan),o=gt(e,s.useFan);void 0===i&&void 0===o||(t.fan={temp:i,use:o})}const n=gt(e,s.fanOverride);void 0!==n&&(t.fanOverride=n);const a=gt(e,s.fanReverse);if(void 0!==a&&(t.fanReverse=a),_e(s.fanPreset)){const i=e.states[s.fanPreset]?.state;i&&(t.fanPreset=i)}i[s.name]=t}return{version:2,type:ut,rooms:i}}async function bt(e){const t=JSON.stringify(e);if(mt=t,navigator.clipboard?.writeText)try{await navigator.clipboard.writeText(t)}catch{}}class $t{constructor(e){this._feedback={},this._timers={},this._onChange=e}get(e){return this._feedback[e]}flash(e,t,i=2e3){void 0!==this._timers[e]&&window.clearTimeout(this._timers[e]),this._feedback={...this._feedback,[e]:t},this._onChange(),this._timers[e]=window.setTimeout(()=>{const t={...this._feedback};delete t[e],this._feedback=t,delete this._timers[e],this._onChange()},i)}dispose(){for(const e of Object.values(this._timers))window.clearTimeout(e);this._timers={},this._feedback={}}}function xt(e,t){return We(t)}function wt(e,t){return e}function At(e){return Boolean(e&&e.trim())}function Et(e){const t=e.room;return At(e.enabled)&&At(e.time)&&(At(t.cooling)||At(t.useCooling)||At(t.heating)||At(t.fan))}async function kt(e,t,i){const s=function(e,t){const i=Le(t);if(i)return{name:i.label,roomKey:t,has_heating:i.has_heating,has_fan:i.has_fan,useCooling:e.use_ac,useHeating:i.has_heating?e.use_heater:void 0,useFan:i.has_fan?e.use_fan:void 0,fanOverride:e.ac_fan_only_override,fanReverse:i.fan_reversible?e.fan_reverse_toggle:void 0,fanPreset:i.has_fan?e.fan_preset_select:void 0,cooling:e.target_cooling,heating:i.has_heating?e.target_heating:void 0,fan:i.has_fan?e.target_fan:void 0}}(t,i);if(!s)return!1;const o=yt(e,[s]);return await bt(o),!0}function St(e){const t=e.split(":");return t.length>=2?`${t[0].padStart(2,"0")}:${t[1].padStart(2,"0")}`:e}function Ct(e,t,i,s){const o=St(s);for(const s of xt(0,t)){if(s.profileId===i)continue;const t=$e(e.states[s.time]?.state);if(t&&t===o)return s}}function Pt(e){const t=(e%1440+1440)%1440,i=Math.floor(t/60),s=t%60;return`${String(i).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function Nt(e,t){const i=function(e,t){const i=new Set;for(const s of xt(0,t)){const t=$e(e.states[s.time]?.state);t&&i.add(St(t))}return i}(e,t),s=new Date,o=60*s.getHours()+s.getMinutes();let r=15*Math.floor(o/15)+15;r<=o&&(r+=15);for(let e=0;e<96;e++){const e=Pt(r);if(!i.has(e))return e;r+=15}return Pt(r)}const Ot=n`
  :host {
    display: block;
  }
...
`;let It=class extends ae{constructor(){super(...arguments),this._profilesOpen=!1,this._busy=!1,this._newProfileName="",this._newProfileTime="06:00",this._showAddForm=!1,this._addError="",this._actionError={},this._renameDrafts={},this._feedbackVersion=0,this._fieldFeedback={},this._openProfileIds=new Set,this._focusAddName=!1,this._pasteRoomSettingsOnCreate=!1,this._buttonFeedback=new $t(()=>{this._feedbackVersion+=1})}connectedCallback(){super.connectedCallback(),this._unsubStore=ze(()=>this.requestUpdate()),je(this.hass)}disconnectedCallback(){super.disconnectedCallback(),this._unsubStore?.(),this._unsubStore=void 0,this._buttonFeedback.dispose()}_routines(){return We(this.roomKey)}_flashField(e,t){this._fieldFeedback={...this._fieldFeedback,[e]:t},window.setTimeout(()=>{if(this._fieldFeedback[e]!==t)return;const i={...this._fieldFeedback};delete i[e],this._fieldFeedback=i},2e3)}_btnFeedback(e){return this._feedbackVersion,this._buttonFeedback.get(e)}updated(e){if(super.updated(e),this._focusAddName&&this.shadowRoot&&(this._focusAddName=!1,requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".profile-add-name");e?.focus()})),!this._focusTarget||!this.shadowRoot)return;const{profileId:t,selector:i}=this._focusTarget,s=new Set(this._openProfileIds);s.add(t),this._openProfileIds=s,requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(i);e?.focus(),this._focusTarget=void 0})}_renderActionButton(e,t,i,s,o={}){const r=this._btnFeedback(e),n="success"===r?"mdi:check":"error"===r?"mdi:alert-circle-outline":i;return L`
    ...
    `}_renderFanPresetRow(e){const t=Ae(this.hass,e);if(!t)return K;const i=t.attributes.options??[];if(i.length<=1)return K;const s=t.state??"Auto";return L`
      <div class="profile-device-row fan-preset-row">
        ...
        <div class="profile-device-controls">
          <select
            ...
            .value=${s}
            @change=${t=>{const i=t.target.value;this.hass.callService("select","select_option",{entity_id:e,option:i})}}
          >
            ${i.map(e=>L`<option value=${e} ?selected=${e===s}>${e}</option>`)}
          </select>
        </div>
      </div>
    `}_renderRoom(e){if(!e.roomKey)return L`<div class="profile-hint">Preset entities loading… refresh in a moment.</div>`;const t=_e(e.fanPreset)?e.fanPreset:void 0,i=t?Ae(this.hass,t):void 0,s=i&&(i.attributes.options??[]).length>1;return L`
      <div class="profile-room-block">
        ...
        ${!1!==e.has_fan?L`
              ${this._renderDeviceRow("Fan",e.useFan,e.fan,s?void 0:{label:"Reverse",entityId:e.fanReverse})}
              ${s&&t?this._renderFanPresetRow(t):K}
            `:K}
      </div>
    `}async _copyProfile(e){const t=`copy-${e.profileId}`;this._clearActionError(e.profileId);try{const i=yt(this.hass,[e.room]);await bt(i),this._buttonFeedback.flash(t,"success",1500)}catch(i){this._surfaceActionError(e.profileId,i,"copy the profile"),this._buttonFeedback.flash(t,"error")}}async _pasteRoutine(e){const t=`paste-${e.profileId}`;this._clearActionError(e.profileId);const i=await async function(){if(navigator.clipboard?.readText)try{const e=await navigator.clipboard.readText();if(e?.trim())return mt=e,e}catch{}return mt}();if(!i)return this._setActionError(e.profileId,"Nothing to paste — copy a profile first."),void this._buttonFeedback.flash(t,"error");const s=function(e){try{const t=JSON.parse(e);if((1===t?.version||2===t?.version)&&t?.type===ut&&t.rooms&&"object"==typeof t.rooms)return t}catch{}return null}(i);if(!s)return this._setActionError(e.profileId,"The clipboard doesn't contain profile settings."),void this._buttonFeedback.flash(t,"error");const o=function(e,t,i,s,o){let r=0;for(const n of t){const t=i.rooms[n.name];if(!t)continue;void 0!==t.fanOverride&&_e(n.fanOverride)&&(o(n.fanOverride,t.fanOverride),r++),void 0!==t.fanReverse&&_e(n.fanReverse)&&(o(n.fanReverse,t.fanReverse),r++),void 0!==t.fanPreset&&_e(n.fanPreset)&&(e.callService("select","select_option",{entity_id:n.fanPreset,option:t.fanPreset}),r++);const a=[{key:"cooling",useId:n.useCooling,tempId:n.cooling,enabled:!0},{key:"heating",useId:n.useHeating,tempId:n.heating,enabled:!1!==n.has_heating},{key:"fan",useId:n.useFan,tempId:n.fan,enabled:!1!==n.has_fan}];for(const e of a){if(!e.enabled)continue;const i=vt("cooling"===e.key?t.cooling:"heating"===e.key?t.heating:t.fan);i&&(void 0!==i.use&&_e(e.useId)&&(o(e.useId,i.use),r++),void 0!==i.temp&&_e(e.tempId)&&(s(e.tempId,i.temp),r++))}}return r}(this.hass,[e.room],s,(e,t)=>be(this.hass,e,t),(e,t)=>function(e,t,i){const s=t.split(".")[0];e.callService(s,i?"turn_on":"turn_off",{entity_id:t})}(this.hass,e,t));if(0===o)return this._setActionError(e.profileId,"Nothing in the clipboard matched this room's devices."),void this._buttonFeedback.flash(t,"error");this._buttonFeedback.flash(t,"success")}async _copyCurrentRoom(){const e="copy-room";try{const t=await kt(this.hass,this.config,this.roomKey);t&&this._showAddForm&&(this._pasteRoomSettingsOnCreate=!0),this._buttonFeedback.flash(e,t?"success":"error",1500)}catch{this._buttonFeedback.flash(e,"error")}}_setActionError(e,t){this._actionError={...this._actionError,[e]:t}}_clearActionError(e){if(void 0===this._actionError[e])return;const t={...this._actionError};delete t[e],this._actionError=t}_surfaceActionError(e,t,i){this._setActionError(e,Re(t)||`Could not ${i}. Check Settings → System → Logs.`)}async _applyNow(e){const t=`apply-${e.profileId}`;this._busy=!0,this._clearActionError(e.profileId);try{await(i=this.hass,s=e.profileId,i.callWS({type:"room_climate_controller/profiles/apply",profile_id:s})),this._buttonFeedback.flash(t,"success")}catch(i){this._surfaceActionError(e.profileId,i,"apply the profile"),this._buttonFeedback.flash(t,"error")}finally{this._busy=!1}var i,s}_renameValue(e){return void 0!==this._renameDrafts[e.profileId]?this._renameDrafts[e.profileId]:wt(e.name,e.profileId)}_savedProfileName(e){return wt(e.name,e.profileId)}async _commitProfileName(e,t){const i=t.trim(),s=this._savedProfileName(e),o=`name-${e.profileId}`;if(i===s){const t={...this._renameDrafts};return delete t[e.profileId],void(this._renameDrafts=t)}if(!i){const t={...this._renameDrafts};return delete t[e.profileId],this._renameDrafts=t,this._setActionError(e.profileId,"Enter a profile name."),void this._flashField(o,"error")}this._busy=!0,this._clearActionError(e.profileId);try{await function(e,t,i){return e.callWS({type:"room_climate_controller/profiles/rename",profile_id:t,name:i})}(this.hass,e.profileId,i);const t={...this._renameDrafts};delete t[e.profileId],this._renameDrafts=t,await je(this.hass),this._flashField(o,"success")}catch(t){this._surfaceActionError(e.profileId,t,"rename the profile"),this._flashField(o,"error")}finally{this._busy=!1}}async _setProfileTime(e,t){const i=`time-${e.profileId}`;if(this._clearActionError(e.profileId),Ct(this.hass,this.roomKey,e.profileId,t))return this._setActionError(e.profileId,this._timeConflictMessage(t,e.profileId)),void this._flashField(i,"error");var s,o,r;if(_e(e.time))try{await(s=this.hass,o=e.time,r=`${t}:00`,"input_datetime"===o.split(".")[0]?s.callService("input_datetime","set_datetime",{entity_id:o,time:r}):s.callService("time","set_value",{entity_id:o,time:r})),await je(this.hass),this._flashField(i,"success")}catch(t){this._surfaceActionError(e.profileId,t,"change the profile time"),this._flashField(i,"error")}}_timeConflictMessage(e,t=""){const i=Ct(this.hass,this.roomKey,t,e);if(!i)return"Another profile in this room already uses that time.";return`“${wt(i.name,i.profileId)}” already runs at ${e} in this room.`}async _addProfile(){const e="add-profile",t="add-profile-time",i=this._newProfileName.trim(),s=St(this._newProfileTime);if(this._addError="",!i)return this._addError="Enter a profile name.",void this._buttonFeedback.flash(e,"error");if(!s)return this._addError="Choose a valid time.",void this._flashField(t,"error");if(Ct(this.hass,this.roomKey,"",s))return this._addError=this._timeConflictMessage(s),void this._flashField(t,"error");this._busy=!0;try{const t=await(o=this.hass,r={name:i,room:this.roomKey,time:s,copy_room_settings:this._pasteRoomSettingsOnCreate},o.callWS({type:"room_climate_controller/profiles/create",...r}));await je(this.hass),this._pasteRoomSettingsOnCreate=!1;const n=t.profile?.id;n&&(this._openProfileIds=new Set([...this._openProfileIds,n])),this._newProfileName="",this._newProfileTime=Nt(this.hass,this.roomKey),this._showAddForm=!1,this._addError="",this._buttonFeedback.flash(e,"success")}catch(t){this._addError=Re(t)||"Could not create profile. Check Settings → System → Logs.",this._buttonFeedback.flash(e,"error")}finally{this._busy=!1}var o,r}async _deleteProfile(e){const t=`delete-${e.profileId}`,i=wt(e.name,e.profileId);if(window.confirm(`Delete profile “${i}”?`)){this._busy=!0,this._clearActionError(e.profileId);try{await(s=this.hass,o=e.profileId,s.callWS({type:"room_climate_controller/profiles/delete",profile_id:o}));const i=new Set(this._openProfileIds);i.delete(e.profileId),this._openProfileIds=i,await je(this.hass),this._buttonFeedback.flash(t,"success",800)}catch(i){this._surfaceActionError(e.profileId,i,"delete the profile"),this._buttonFeedback.flash(t,"error")}finally{this._busy=!1}var s,o}}_renderProfile(e){const t=_e(e.time)?$e(this.hass.states[e.time]?.state):"",i=wt(e.name,e.profileId),s=function(e,t){const i=$e(e.states[t.time]?.state);return!!i&&Boolean(Ct(e,t.roomKey,t.profileId,i))}(this.hass,e),o=`time-${e.profileId}`,r=`name-${e.profileId}`;return L`
      <details
        class="profile-item"
