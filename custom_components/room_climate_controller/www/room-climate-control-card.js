 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,A=e=>e,E=w.trustedTypes,k=E?E.createPolicy("lit-html",{createHTML:e=>e}):void 0,C="$lit$",S=`lit$${Math.random().toFixed(9).slice(2)}$`,P="?"+S,N=`<${P}>`,O=document,I=()=>O.createComment(""),R=e=>null===e||"object"!=typeof e&&"function"!=typeof e,F=Array.isArray,T="[ \t\n\f\r]",M=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,D=/-->/g,H=/>/g,U=RegExp(`>|${T}(?:([^\\s"'>=/]+)(${T}*=${T}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),z=/'/g,j=/"/g,B=/^(?:script|style|textarea|title)$/i,L=(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}))(1),G=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),W=new WeakMap,q=O.createTreeWalker(O,129);function V(e,t){if(!F(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(t):t}class J{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,r=0;const n=e.length-1,a=this.parts,[l,c]=((e,t)=>{const i=e.length-1,o=[];let s,r=2===t?"<svg>":3===t?"<math>":"",n=M;for(let t=0;t<i;t++){const i=e[t];let a,l,c=-1,d=0;for(;d<i.length&&(n.lastIndex=d,l=n.exec(i),null!==l);)d=n.lastIndex,n===M?"!--"===l[1]?n=D:void 0!==l[1]?n=H:void 0!==l[2]?(B.test(l[2])&&(s=RegExp("</"+l[2],"g")),n=U):void 0!==l[3]&&(n=U):n===U?">"===l[0]?(n=s??M,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?U:'"'===l[3]?j:z):n===j||n===z?n=U:n===D||n===H?n=M:(n=U,s=void 0);const h=n===U&&e[t+1].startsWith("/>")?" ":"";r+=n===M?i+N:c>=0?(o.push(a),i.slice(0,c)+C+i.slice(c)+S+h):i+S+(-2===c?t:h)}return[V(e,r+(e[i]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),o]})(e,t);if(this.el=J.createElement(l,i),q.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(o=q.nextNode())&&a.length<n;){if(1===o.nodeType){if(o.hasAttributes())for(const e of o.getAttributeNames())if(e.endsWith(C)){const t=c[r++],i=o.getAttribute(e).split(S),n=/([.?@])?(.*)/.exec(t);a.push({type:1,index:s,name:n[2],strings:i,ctor:"."===n[1]?ee:"?"===n[1]?te:"@"===n[1]?ie:Q}),o.removeAttribute(e)}else e.startsWith(S)&&(a.push({type:6,index:s}),o.removeAttribute(e));if(B.test(o.tagName)){const e=o.textContent.split(S),t=e.length-1;if(t>0){o.textContent=E?E.emptyScript:"";for(let i=0;i<t;i++)o.append(e[i],I()),q.nextNode(),a.push({type:2,index:++s});o.append(e[t],I())}}}else if(8===o.nodeType)if(o.data===P)a.push({type:2,index:s});else{let e=-1;for(;-1!==(e=o.data.indexOf(S,e+1));)a.push({type:7,index:s}),e+=S.length-1}s++}}static createElement(e,t){const i=O.createElement("template");return i.innerHTML=e,i}}function Z(e,t,i=e,o){if(t===G)return t;let s=void 0!==o?i._$Co?.[o]:i._$Cl;const r=R(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),void 0===r?s=void 0:(s=new r(e),s._$AT(e,i,o)),void 0!==o?(i._$Co??=[])[o]=s:i._$Cl=s),void 0!==s&&(t=Z(e,s._$AS(e,t.values),s,o)),t}class Y{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,o=(e?.creationScope??O).importNode(t,!0);q.currentNode=o;let s=q.nextNode(),r=0,n=0,a=i[0];for(;void 0!==a;){if(r===a.index){let t;2===a.type?t=new X(s,s.nextSibling,this,e):1===a.type?t=new a.ctor(s,a.name,a.strings,this,e):6===a.type&&(t=new oe(s,this,e)),this._$AV.push(t),a=i[++n]}r!==a?.index&&(s=q.nextNode(),r++)}return q.currentNode=O,o}p(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,o){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cv=o?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=Z(this,e,t),R(e)?e===K||null==e||""===e?(this._$AH!==K&&this._$AR(),this._$AH=K):e!==this._$AH&&e!==G&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>F(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==K&&R(this._$AH)?this._$AA.nextSibling.data=e:this.T(O.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,o="number"==typeof i?this._$AC(e):(void 0===i.el&&(i.el=J.createElement(V(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===o)this._$AH.p(t);else{const e=new Y(o,this),i=e.u(this.options);e.p(t),this.T(i),this._$AH=e}}_$AC(e){let t=W.get(e.strings);return void 0===t&&W.set(e.strings,t=new J(e)),t}k(e){F(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new X(this.O(I()),this.O(I()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=A(e).nextSibling;A(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class Q{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,o,s){this.type=1,this._$AH=K,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=K}_$AI(e,t=this,i,o){const s=this.strings;let r=!1;if(void 0===s)e=Z(this,e,t,0),r=!R(e)||e!==this._$AH&&e!==G,r&&(this._$AH=e);else{const o=e;let n,a;for(e=s[0],n=0;n<s.length-1;n++)a=Z(this,o[i+n],t,n),a===G&&(a=this._$AH[n]),r||=!R(a)||a!==this._$AH[n],a===K?e=K:e!==K&&(e+=(a??"")+s[n+1]),this._$AH[n]=a}r&&!o&&this.j(e)}j(e){e===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ee extends Q{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===K?void 0:e}}class te extends Q{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==K)}}class ie extends Q{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){if((e=Z(this,e,t,0)??K)===G)return;const i=this._$AH,o=e===K&&i!==K||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==K&&(i===K||o);o&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class oe{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){Z(this,e)}}const se={I:X},re=w.litHtmlPolyfillSupport;re?.(J,X),(w.litHtmlVersions??=[]).push("3.3.3");const ne=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let ae=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,i)=>{const o=i?.renderBefore??t;let s=o._$litPart$;if(void 0===s){const e=i?.renderBefore??null;o._$litPart$=s=new X(t.insertBefore(I(),e),e,void 0,i??{})}return s._$AI(e),s})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return G}};ae._$litElement$=!0,ae.finalized=!0,ne.litElementHydrateSupport?.({LitElement:ae});const le=ne.litElementPolyfillSupport;le?.({LitElement:ae}),(ne.litElementVersions??=[]).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function fe(e){return pe({...e,state:!0,attribute:!1})}const ue="sensor.outdoor_temperature";function me(e,t,i,o){if(!e)return null;const s="fan"===o?'(\n    (state && state.state) ||\n    y\n  ) === "off" ? 0 : 1':function(e){return`(\n    (state && state.attributes && state.attributes.hvac_mode) ||\n    (state && state.state) ||\n    y\n  ) === "${"cooling"===e?"cool":"heat"}" ? 1 : 0`}(o);return{entity:e,filters:[{map_y:s}],name:`$ex '${t}: ' + (Number(ys.at(-1)) === 1 ? 'On' : Number(ys.at(-1)) === 0 ? 'Off' : '—')`,hovertemplate:"%{x|%H:%M}: %{y}<extra></extra>",yaxis:"y2",visible:`$ex hass.states['${e}'] !== undefined`,line:{shape:"hv",color:i,width:1.5}}}function _e(e){return Boolean(e&&e.trim())}function ge(e,t,i="—"){if(!_e(t)||!e.states[t])return i;const o=e.states[t];if("unavailable"===o.state||"unknown"===o.state)return i;const s=o.attributes.unit_of_measurement||"",r=parseFloat(o.state);return Number.isNaN(r)?e.formatEntityState(o):`${Number.isInteger(r)?r:r.toFixed(1)}${s?` ${s}`:""}`}function ve(e,t){if(!_e(t)||!e.states[t])return"—";const i=e.states[t].state;if("unavailable"===i||"unknown"===i)return"—";const o=Math.round(parseFloat(i));return Number.isNaN(o)?"—":`${o} W now`}function ye(e,t){const i=e.states[t];if(!i)return"—";const o=i.attributes.hvac_mode||i.state;return o?o.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase()):"—"}function be(e,t,i){const o=t.split(".")[0];e.callService(o,"set_value",{entity_id:t,value:i})}function $e(e){if(!e||"unknown"===e||"unavailable"===e)return"";const t=e.split(":");return t.length>=2?`${t[0].padStart(2,"0")}:${t[1].padStart(2,"0")}`:e}function xe(e,t){e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}async function we(e,t){if(!await async function(e,t=15e3){if(customElements.get(e))return!0;try{return await Promise.race([customElements.whenDefined(e),new Promise((i,o)=>{setTimeout(()=>o(new Error(`Timed out waiting for ${e}`)),t)})]),!0}catch{return!1}}("plotly-graph"))return null;const{type:i,...o}=t,s=document.createElement("plotly-graph");return s.setConfig(o),s.hass=e,s}function Ae(e,t){return e.states[t]}function Ee(e,t,i=0){const o=parseFloat(e.states[t]?.state??"");return Number.isNaN(o)?i:o}function ke(e,t,i,o){if(!_e(t)||!_e(i))return null;const s=Ee(e,t),r=Ee(e,i,1);return o?s-r:s+r}function Ce(e,t,i,o){const s=Ae(e,t);if(!s)return K;const r=Number(s.attributes.min??1),n=Number(s.attributes.max??20),a=Number(s.attributes.step??1),l=Ee(e,t,r);return L`
    <div class="settings-row">
      ...
      <div class="settings-row-control settings-slider-control">
        <input
          ...
          step=${a}
          .value=${String(l)}
          @input=${i=>{const o=parseFloat(i.target.value);Number.isNaN(o)||be(e,t,o)}}
        />
        <span class="settings-offset-value">${l}°F</span>
      </div>
    </div>
  `}function Se(e,t,i){const o=Boolean(t.subtractOffsets),s=ke(e,t.target,t.mediumOffset,o),r=ke(e,t.target,t.highOffset,o);return L`
    <div class="settings-section">
      <div class="settings-section-title">${t.title}</div>
      ${function(e,t,i){const o=Ae(e,t);if(!o)return K;const s=Number(o.attributes.min??0),r=Number(o.attributes.max??100),n=Number(o.attributes.step??1),a=Ee(e,t);return L`
    <div class="settings-row">
      <span class="settings-row-label">${i}</span>
      <div class="settings-row-control settings-target-control">
        <input
          ...
          step=${n}
          .value=${String(a)}
          @change=${i=>{const o=parseFloat(i.target.value);Number.isNaN(o)||be(e,t,o)}}
        />
        <span class="settings-unit">°F</span>
      </div>
    </div>
  `}(e,t.target,"Target")}
      ${Ce(e,t.mediumOffset,"Medium offset",s)}
      ${Ce(e,t.highOffset,"High offset",r)}
      ${function(e,t){if(!t)return K;const i=Ae(e,t);return i?L`
    <div class="settings-row">
...
`;function Ie(e){return e.callWS({type:"room_climate_controller/rooms/list"})}function Re(e){return e.callWS({type:"room_climate_controller/profiles/list"})}function Fe(e){if(e&&"object"==typeof e&&"message"in e){const t=e.message;if("string"==typeof t)return t.trim()}return""}let Te=[],Me=[],De=!1,He=null;const Ue=new Set;function ze(e){return Ue.add(e),()=>Ue.delete(e)}async function je(e){return He||(He=(async()=>{try{const[t,i]=await Promise.all([Ie(e),Re(e)]);Te=t.rooms??[],Me=i.profiles??[],De=!0,function(){for(const e of Ue)e()}()}catch{}finally{He=null}})(),He)}function Be(){return Te}function Le(e){return Te.find(t=>t.key===e)}function Ge(){return Te.map(e=>({key:e.key,label:e.label,has_heating:e.has_heating,has_fan:e.has_fan}))}function Ke(e){const t=e.entities.presets??{},i={name:Le(e.room)?.label??e.room,roomKey:e.room,has_heating:e.has_heating,has_fan:e.has_fan,useCooling:t.cooling?.use_entity??void 0,useHeating:t.heating?.use_entity??void 0,useFan:t.fan?.use_entity??void 0,fanOverride:e.entities.fan_override??void 0,fanReverse:e.entities.fan_reverse??void 0,cooling:t.cooling?.temp_entity??"",heating:t.heating?.temp_entity??void 0,fan:t.fan?.temp_entity??void 0};return{profileId:e.id,name:e.name,enabled:e.entities.enabled??"",time:e.entities.time??"",roomKey:e.room,room:i}}function We(e){return Me.filter(t=>t.room===e).map(Ke).sort((e,t)=>{const i=qe(e.profileId),o=qe(t.profileId);return i!==o?i.localeCompare(o):e.profileId.localeCompare(t.profileId,void 0,{numeric:!0})})}function qe(e){return Me.find(t=>t.id===e)?.time??"99:99"}const Ve={use:null,target:null,medium_offset:null,high_offset:null};function Je(e){return e.room?.trim()||e.profile_room_key?.trim()||void 0}function Ze(e){const t=Je(e);if(!t)return;const i=Le(t);if(!i)return;const o=i.entities,s=e=>o.live[e]??Ve,r=s("cooling"),n=s("heating"),a=s("fan");return function(e={}){return{type:"custom:room-climate-control",room_name:"Room",temp_sensor:"",use_ac:"",use_heater:"",use_fan:"",manual_mode:"",target_cooling:"",cooling_medium_offset:"",cooling_high_offset:"",target_heating:"",heating_medium_offset:"",heating_high_offset:"",target_fan:"",fan_medium_offset:"",fan_high_offset:"",outdoor_sensor:ue,time_range:"",...e}}({type:"custom:room-climate-control",room:t,profile_room_key:t,room_name:i.label,temp_sensor:o.temperature??"",humidity_sensor:o.humidity??"",power_sensor:o.power??"",ac_entity:o.ac_entity??"",heater_entity:o.heater_entity??"",fan_entity:o.fan_entity??"",window_sensors:o.window_sensors??[],manual_mode:o.manual_mode??"",ac_fan_only_override:o.ac_fan_only_override??"",heater_fan_only_override:o.heater_fan_only_override??"",fan_reversible:i.fan_reversible??!1,fan_reverse_toggle:o.fan_reverse??"",use_ac:r.use??"",target_cooling:r.target??"",cooling_medium_offset:r.medium_offset??"",cooling_high_offset:r.high_offset??"",use_heater:n.use??"",target_heating:n.target??"",heating_medium_offset:n.medium_offset??"",heating_high_offset:n.high_offset??"",use_fan:a.use??"",target_fan:a.target??"",fan_medium_offset:a.medium_offset??"",fan_high_offset:a.high_offset??"",outdoor_sensor:e.outdoor_sensor??o.outdoor??ue,time_range:e.time_range??o.time_range??"",ac_device_button:o.ac_device_button??e.ac_device_button,heater_device_button:o.heater_device_button??e.heater_device_button,fan_device_button:o.fan_device_button??e.fan_device_button})}let Ye=class extends ae{constructor(){super(...arguments),this._settingsOpen=!1,this._graphDialog=null,this._graphOverlay=new Ne}setConfig(e){if(this._userConfig=e,!Je(e))return this._config=void 0,void(this._configError="Select a room in the card editor.");this._configError=void 0,this._resolveRoom()}_resolveRoom(){const e=Ze(this._userConfig);if(e)return this._config=e,void(this._configError=void 0);const t=Je(this._userConfig);Be().length>0&&t&&!function(e){return Be().some(t=>t.key===e)}(t)&&(this._config=void 0,this._configError=`Unknown room "${t}". Add it in the Room Climate integration.`)}getCardSize(){return 6}static getConfigElement(){return document.createElement("room-climate-control-editor")}static getStubConfig(){const e=Be()[0]?.key;return{type:"custom:room-climate-control",room:e??""}}connectedCallback(){super.connectedCallback(),je(this.hass),this._unsubRooms??=ze(()=>{this._resolveRoom(),this.requestUpdate()})}disconnectedCallback(){super.disconnectedCallback(),this._graphOverlay.close(),this._unsubRooms?.(),this._unsubRooms=void 0}updated(e){if(!(e.has("hass")&&this._graphDialog&&this.hass&&this._config))return;this._overlayGraphEl&&(this._overlayGraphEl.hass=this.hass),this._overlayPowerNowEl&&_e(this._config.power_sensor)&&(this._overlayPowerNowEl.textContent=ve(this.hass,this._config.power_sensor));const t=this._config.time_range||"",i=this.hass.states[t]?.state;i&&i!==this._lastGraphHours&&(this._lastGraphHours=i,this._mountGraphOverlay())}render(){if(!this.hass)return L``;if(this._configError)return L`
        <ha-card>
    ...
    `}_renderProfilesPanel(e){const t=function(e){const t=e.profile_room_key?.trim();if(t)return t;const i=e.manual_mode?.trim();if(i){const e=Be().find(e=>e.entities.manual_mode===i);if(e)return e.key}const o=e.manual_mode?.match(/^input_boolean\.([a-z0-9_]+)_climate_manual_mode$/);return o&&Be().some(e=>e.key===o[1])?o[1]:void 0}(e);return t?L`
      <room-climate-profiles-panel
        .hass=${this.hass}
        .config=${e}
        .roomKey=${t}
      ></room-climate-profiles-panel>
    `:K}_renderDevicesPanel(e){const t=[],i=(o=this.hass,(e.window_sensors??[]).some(e=>_e(e)&&"on"===o.states[e]?.state));var o;const s=(e,i,o,s,r,n,a=!1)=>{if(!_e(i)||!function(e,t){if(!_e(t))return!1;const i=e.states[t];return!!i&&"unavailable"!==i.state&&"unknown"!==i.state}(this.hass,i))return;const l=Ae(this.hass,o);if(!l)return;const c=i,d=function(e,t,i=72){const o=e.states[t];if(!o)return i;const s=parseFloat(o.state);return Number.isNaN(s)?i:Math.round(s)}(this.hass,s),h=r(this.hass,c),p=_e(n),f=p?Ae(this.hass,n):void 0;t.push(L`
        <div class="device-row">
          <div
            ...
            tabindex="0"
            @click=${()=>xe(this,c)}
            @keydown=${e=>{"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),xe(this,c))}}
          >
            <div class="device-label">${e}</div>
            <div class="device-secondary">
              <span>${d}°F target</span>
          ...
          <div class="device-toggles">
            ...
            <div class="use-toggle">
              ...
              <div
                class=${a?"rcc-suppressed":""}
                aria-disabled=${a?"true":K}
                title=${a?"Disabled while the window is open":K}
              >
      ...
      `)},r=_e(e.ac_entity)&&_e(e.heater_entity)&&e.ac_entity===e.heater_entity;if(s("Cooling",e.ac_entity,e.use_ac,e.target_cooling,ye,e.ac_fan_only_override,i),s("Heating",e.heater_entity,e.use_heater,e.target_heating,ye,r?void 0:e.heater_fan_only_override,i),s("Fan",e.fan_entity,e.use_fan,e.target_fan,(t,i)=>function(e,t,i=!1){const o=e.states[t];if(!o)return"—";if("off"===o.state)return"Off";const s=o.attributes.direction,r=o.attributes.preset_mode;let n="";"forward"===s||"reverse"===s?n="reverse"===s?" (Reverse)":" (Forward)":i&&null!=r&&(n="reverse"===r?" (Reverse)":" (Forward)");const a=o.attributes.percentage;return null!=a?`${a}%${n}`:o.state?o.state.replace(/\b\w/g,e=>e.toUpperCase())+n:"—"}(t,i,e.fan_reversible??!1)),0===t.length)return K;(e.window_sensors??[]).length>0&&t.unshift(L`
      ...
      `);const n=Ae(this.hass,e.manual_mode);return n&&t.push(L`
  ...
  `}(this.hass,this._config)}
    ...
    `}_onSettingsDeviceButton(e,t){t.disabled||(t.disabled=!0,async function(e,t){const i=t.action;if("perform-action"!==i&&"call-service"!==i)return;const o=t.perform_action??t.service;if(!o?.includes("."))return;const[s,r]=o.split(".",2),n={...t.data??{}},a=t.target;void 0!==a?.entity_id&&(n.entity_id=a.entity_id),await e.callService(s,r,n)}(this.hass,e.tap_action).finally(()=>{window.setTimeout(()=>{t.disabled=!1},1e3)}))}_openSettings(){this._closeGraphDialog(),this._settingsOpen=!0}_closeSettings(){this._settingsOpen=!1}_openGraphDialog(e){this._config&&(this._closeSettings(),this._graphDialog=e,this._lastGraphHours=this.hass.states[this._config.time_range||""]?.state,this._mountGraphOverlay())}_closeGraphDialog(){this._graphOverlay.isOpen?this._graphOverlay.close():this._clearGraphDialogState()}_clearGraphDialogState(){this._graphDialog=null,this._lastGraphHours=void 0,this._overlayGraphEl=void 0,this._overlayPowerNowEl=void 0}async _mountGraphOverlay(){if(!this._graphDialog||!this.hass||!this._config)return;const e=this._config,t={energy:`${e.room_name} · Energy Use`,history:`${e.room_name} · History`},i=this._graphOverlay.open(t[this._graphDialog],()=>{this._clearGraphDialogState()});i.innerHTML="",this._overlayGraphEl=void 0,this._overlayPowerNowEl=void 0;const o=e.time_range||"",s=parseInt(this.hass.states[o]?.state||"24",10)||24;if(o){const e=await async function(e,t){if(!window.loadCardHelpers)return null;const i=await window.loadCardHelpers(),o=await i.createCardElement(t);return o&&(o.hass=e),o}(this.hass,function(e){return{type:"entities",entities:[{entity:e,name:"Time range (hours)"}]}}(o));e&&i.appendChild(e)}if("energy"===this._graphDialog){if(_e(e.power_sensor)){const t=document.createElement("div");t.className="rcc-overlay-power-now",t.textContent=ve(this.hass,e.power_sensor),i.appendChild(t),this._overlayPowerNowEl=t}const t=document.createElement("div");t.className="rcc-overlay-graph-host",i.appendChild(t);const r=await we(this.hass,function(e,t){return{type:"custom:plotly-graph",hours_to_show:t,refresh_interval:60,config:{displayModeBar:!1,scrollZoom:!1},entities:[{entity:e.power_sensor,filters:["force_numeric"],name:"$ex 'Power: ' + (ys.at(-1) != null ? Math.round(ys.at(-1)) + ' W' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.0f} W<extra></extra>",line:{color:"rgb(255,165,0)",width:2}}],layout:{dragmode:!1,height:400,legend:{orientation:"h",yanchor:"bottom",y:1.02,xanchor:"center",x:.5},margin:{t:40,r:20},yaxis:{title:"Watts",showgrid:!1,zeroline:!1,rangemode:"tozero",fixedrange:!0},xaxis:{showgrid:!1,fixedrange:!0}}}}(e,s));return r?(t.appendChild(r),this._overlayGraphEl=r):t.textContent="Unable to load energy graph (plotly-graph unavailable).",void(this._lastGraphHours=this.hass.states[o]?.state)}const r=document.createElement("div");r.className="rcc-overlay-graph-host",i.appendChild(r);const n=await we(this.hass,function(e,t){const i=e.outdoor_sensor||ue,o=[{entity:e.temp_sensor,filters:["force_numeric",{fn:"({ xs, ys, vars }) => {\n            vars._roomTempVals = ys.map(Number).filter((n) => !isNaN(n));\n            return { xs, ys };\n          }"}],name:"$ex 'Room: ' + (ys.at(-1) != null ? ys.at(-1).toFixed(1) + ' °F' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.1f} °F<extra></extra>",yaxis:"y",line:{color:"rgb(255,165,0)",width:2}},{entity:i,filters:["force_numeric",{fn:"({ xs, ys, vars }) => {\n            const outdoor = ys.map(Number).filter((n) => !isNaN(n));\n            const all = [...(vars._roomTempVals || []), ...outdoor];\n            if (all.length) {\n              const dmin = Math.min(...all);\n              const dmax = Math.max(...all);\n              vars.tempYRange = [Math.min(20, dmin) - 1, Math.max(100, dmax) + 1];\n            } else {\n              vars.tempYRange = [20, 100];\n            }\n            return { xs, ys };\n          }"}],name:"$ex 'Outdoor: ' + (ys.at(-1) != null ? ys.at(-1).toFixed(1) + ' °F' : '—')",hovertemplate:"%{x|%H:%M}: %{y:.1f} °F<extra></extra>",yaxis:"y",line:{color:"rgb(100,180,255)",width:2}}],s=me(e.ac_entity,"Cooling","rgb(30,144,255)","cooling"),r=me(e.heater_entity,"Heating","rgb(220,60,60)","heating"),n=me(e.fan_entity,"Fan","rgb(0,180,160)","fan");return s&&o.push(s),r&&o.push(r),n&&o.push(n),{type:"custom:plotly-graph",hours_to_show:t,refresh_interval:60,config:{displayModeBar:!1,scrollZoom:!1},entities:o,layout:{dragmode:!1,height:400,legend:{orientation:"h",yanchor:"bottom",y:1.02,xanchor:"center",x:.5},margin:{t:0,r:60},yaxis:{title:"°F",showgrid:!1,zeroline:!1,range:"$ex vars.tempYRange || [20, 100]",autorange:!1,fixedrange:!0},yaxis2:{title:"State",showgrid:!1,zeroline:!1,overlaying:"y",side:"right",range:[0,1.2],autorange:!1,fixedrange:!0,tickvals:[0,1],ticktext:["Off","On"]},xaxis:{showgrid:!1,fixedrange:!0}}}}(e,s));n?(r.appendChild(n),this._overlayGraphEl=n):r.textContent="Unable to load history graph (plotly-graph unavailable).",this._lastGraphHours=this.hass.states[o]?.state}static get styles(){return Oe}};e([pe({attribute:!1})],Ye.prototype,"hass",void 0),e([fe()],Ye.prototype,"_config",void 0),e([fe()],Ye.prototype,"_configError",void 0),e([fe()],Ye.prototype,"_settingsOpen",void 0),e([fe()],Ye.prototype,"_graphDialog",void 0),Ye=e([ce("room-climate-control")],Ye);const Xe={room:"Room",outdoor_sensor:"Outdoor temperature sensor",time_range:"Graph time-range helper",ac_device_button:"A/C lights & sound button (tap_action)",heater_device_button:"Heater lights & sound button (tap_action)",fan_device_button:"Fan lights & sound button (tap_action)"},Qe=["outdoor_sensor","time_range"],et=[{name:"outdoor_sensor",selector:{entity:{filter:[{domain:"sensor",device_class:"temperature"}]}}},{name:"time_range",selector:{entity:{filter:[{domain:"select"},{domain:"input_select"}]}}}];let tt=class extends ae{constructor(){super(...arguments),this._schemaKey="",this._computeLabel=e=>Xe[e.name]||e.name}setConfig(e){this._config={...e,type:"custom:room-climate-control"}}connectedCallback(){super.connectedCallback(),this.hass&&je(this.hass),this._unsub??=ze(()=>this.requestUpdate())}disconnectedCallback(){super.disconnectedCallback(),this._unsub?.(),this._unsub=void 0}_getSchema(e){const t=e.map(e=>e.key).join(",");return this._schema&&t===this._schemaKey||(this._schema=function(e){return[{name:"room",required:!0,selector:{select:{mode:"dropdown",options:e.map(e=>({value:e.key,label:e.label}))}}},...et]}(e),this._schemaKey=t),this._schema}render(){if(!this.hass||!this._config)return L``;const e=Ge(),t=Le(this._config.room??"")?.entities,i=function(e,t={}){return{room:e.room??"",outdoor_sensor:e.outdoor_sensor??t.outdoor_sensor??"",time_range:e.time_range??t.time_range??""}}(this._config,{outdoor_sensor:t?.outdoor,time_range:t?.time_range});return L`
      ...
      ></ha-form>
    `}_valueChanged(e){e.stopPropagation();const t=e.detail.value,i={...this._config,...t,type:"custom:room-climate-control"},o=i;for(const e of Qe){const t=o[e];(null==t||""===t||"object"==typeof t&&0===Object.keys(t).length)&&delete o[e]}var s,r;this._config=i,s=this,r=this._config,s.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:r}}))}static get styles(){return n`
      :host {
        display: block;
        padding: 16px;
      }
    ...
    `}};e([pe({attribute:!1})],tt.prototype,"hass",void 0),e([fe()],tt.prototype,"_config",void 0),tt=e([ce("room-climate-control-editor")],tt);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const it=2;let ot=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:st}=se,rt=e=>e,nt=()=>document.createComment(""),at=(e,t,i)=>{const o=e._$AA.parentNode,s=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=o.insertBefore(nt(),s),r=o.insertBefore(nt(),s);i=new st(t,r,e,e.options)}else{const t=i._$AB.nextSibling,r=i._$AM,n=r!==e;if(n){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==r._$AU&&i._$AP(t)}if(t!==s||n){let e=i._$AA;for(;e!==t;){const t=rt(e).nextSibling;rt(o).insertBefore(e,s),e=t}}}return i},lt=(e,t,i=e)=>(e._$AI(t,i),e),ct={},dt=(e,t=ct)=>e._$AH=t,ht=e=>{e._$AR(),e._$AA.remove()},pt=(e,t,i)=>{const o=new Map;for(let s=t;s<=i;s++)o.set(e[s],s);return o},ft=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends ot{constructor(e){if(super(e),e.type!==it)throw Error("repeat() can only be used in text expressions")}dt(e,t,i){let o;void 0===i?i=t:void 0!==t&&(o=t);const s=[],r=[];let n=0;for(const t of e)s[n]=o?o(t,n):n,r[n]=i(t,n),n++;return{values:r,keys:s}}render(e,t,i){return this.dt(e,t,i).values}update(e,[t,i,o]){const s=(e=>e._$AH)(e),{values:r,keys:n}=this.dt(t,i,o);if(!Array.isArray(s))return this.ut=n,r;const a=this.ut??=[],l=[];let c,d,h=0,p=s.length-1,f=0,u=r.length-1;for(;h<=p&&f<=u;)if(null===s[h])h++;else if(null===s[p])p--;else if(a[h]===n[f])l[f]=lt(s[h],r[f]),h++,f++;else if(a[p]===n[u])l[u]=lt(s[p],r[u]),p--,u--;else if(a[h]===n[u])l[u]=lt(s[h],r[u]),at(e,l[u+1],s[h]),h++,u--;else if(a[p]===n[f])l[f]=lt(s[p],r[f]),at(e,s[h],s[p]),p--,f++;else if(void 0===c&&(c=pt(n,f,u),d=pt(a,h,p)),c.has(a[h]))if(c.has(a[p])){const t=d.get(n[f]),i=void 0!==t?s[t]:null;if(null===i){const t=at(e,s[h]);lt(t,r[f]),l[f]=t}else l[f]=lt(i,r[f]),at(e,s[h],i),s[t]=null;f++}else ht(s[p]),p--;else ht(s[h]),h++;for(;f<=u;){const t=at(e,l[u+1]);lt(t,r[f]),l[f++]=t}for(;h<=p;){const e=s[h++];null!==e&&ht(e)}return this.ut=n,dt(e,l),G}}),ut="daily-routine-climate-temps";
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let mt=null;function _t(e,t){if(!_e(t))return;const i=parseFloat(e.states[t]?.state??"");return Number.isNaN(i)?void 0:Math.round(i)}function gt(e,t){if(!_e(t))return;const i=e.states[t]?.state;return"on"===i||"off"!==i&&void 0}function vt(e){if(void 0!==e)return"number"==typeof e?{temp:e}:e}function yt(e,t){const i={};for(const o of t){const t={},s=_t(e,o.cooling),r=gt(e,o.useCooling);if(void 0===s&&void 0===r||(t.cooling={temp:s,use:r}),!1!==o.has_heating){const i=_t(e,o.heating),s=gt(e,o.useHeating);void 0===i&&void 0===s||(t.heating={temp:i,use:s})}if(!1!==o.has_fan){const i=_t(e,o.fan),s=gt(e,o.useFan);void 0===i&&void 0===s||(t.fan={temp:i,use:s})}const n=gt(e,o.fanOverride);void 0!==n&&(t.fanOverride=n);const a=gt(e,o.fanReverse);void 0!==a&&(t.fanReverse=a),i[o.name]=t}return{version:2,type:ut,rooms:i}}async function bt(e){const t=JSON.stringify(e);if(mt=t,navigator.clipboard?.writeText)try{await navigator.clipboard.writeText(t)}catch{}}class $t{constructor(e){this._feedback={},this._timers={},this._onChange=e}get(e){return this._feedback[e]}flash(e,t,i=2e3){void 0!==this._timers[e]&&window.clearTimeout(this._timers[e]),this._feedback={...this._feedback,[e]:t},this._onChange(),this._timers[e]=window.setTimeout(()=>{const t={...this._feedback};delete t[e],this._feedback=t,delete this._timers[e],this._onChange()},i)}dispose(){for(const e of Object.values(this._timers))window.clearTimeout(e);this._timers={},this._feedback={}}}function xt(e,t){return We(t)}function wt(e,t){return e}function At(e){return Boolean(e&&e.trim())}function Et(e){const t=e.room;return At(e.enabled)&&At(e.time)&&(At(t.cooling)||At(t.useCooling)||At(t.heating)||At(t.fan))}async function kt(e,t,i){const o=function(e,t){const i=Le(t);if(i)return{name:i.label,roomKey:t,has_heating:i.has_heating,has_fan:i.has_fan,useCooling:e.use_ac,useHeating:i.has_heating?e.use_heater:void 0,useFan:i.has_fan?e.use_fan:void 0,fanOverride:e.ac_fan_only_override,fanReverse:i.fan_reversible?e.fan_reverse_toggle:void 0,cooling:e.target_cooling,heating:i.has_heating?e.target_heating:void 0,fan:i.has_fan?e.target_fan:void 0}}(t,i);if(!o)return!1;const s=yt(e,[o]);return await bt(s),!0}function Ct(e){const t=e.split(":");return t.length>=2?`${t[0].padStart(2,"0")}:${t[1].padStart(2,"0")}`:e}function St(e,t,i,o){const s=Ct(o);for(const o of xt(0,t)){if(o.profileId===i)continue;const t=$e(e.states[o.time]?.state);if(t&&t===s)return o}}function Pt(e){const t=(e%1440+1440)%1440,i=Math.floor(t/60),o=t%60;return`${String(i).padStart(2,"0")}:${String(o).padStart(2,"0")}`}function Nt(e,t){const i=function(e,t){const i=new Set;for(const o of xt(0,t)){const t=$e(e.states[o.time]?.state);t&&i.add(Ct(t))}return i}(e,t),o=new Date,s=60*o.getHours()+o.getMinutes();let r=15*Math.floor(s/15)+15;r<=s&&(r+=15);for(let e=0;e<96;e++){const e=Pt(r);if(!i.has(e))return e;r+=15}return Pt(r)}const Ot=n`
  :host {
    display: block;
  }
...
`;let It=class extends ae{constructor(){super(...arguments),this._profilesOpen=!1,this._busy=!1,this._newProfileName="",this._newProfileTime="06:00",this._showAddForm=!1,this._addError="",this._actionError={},this._renameDrafts={},this._feedbackVersion=0,this._fieldFeedback={},this._openProfileIds=new Set,this._focusAddName=!1,this._pasteRoomSettingsOnCreate=!1,this._buttonFeedback=new $t(()=>{this._feedbackVersion+=1})}connectedCallback(){super.connectedCallback(),this._unsubStore=ze(()=>this.requestUpdate()),je(this.hass)}disconnectedCallback(){super.disconnectedCallback(),this._unsubStore?.(),this._unsubStore=void 0,this._buttonFeedback.dispose()}_routines(){return We(this.roomKey)}_flashField(e,t){this._fieldFeedback={...this._fieldFeedback,[e]:t},window.setTimeout(()=>{if(this._fieldFeedback[e]!==t)return;const i={...this._fieldFeedback};delete i[e],this._fieldFeedback=i},2e3)}_btnFeedback(e){return this._feedbackVersion,this._buttonFeedback.get(e)}updated(e){if(super.updated(e),this._focusAddName&&this.shadowRoot&&(this._focusAddName=!1,requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".profile-add-name");e?.focus()})),!this._focusTarget||!this.shadowRoot)return;const{profileId:t,selector:i}=this._focusTarget,o=new Set(this._openProfileIds);o.add(t),this._openProfileIds=o,requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(i);e?.focus(),this._focusTarget=void 0})}_renderActionButton(e,t,i,o,s={}){const r=this._btnFeedback(e),n="success"===r?"mdi:check":"error"===r?"mdi:alert-circle-outline":i;return L`
      <button
        type="button"
    ...
    `:L`<div class="profile-hint">Preset entities loading… refresh in a moment.</div>`}async _copyProfile(e){const t=`copy-${e.profileId}`;this._clearActionError(e.profileId);try{const i=yt(this.hass,[e.room]);await bt(i),this._buttonFeedback.flash(t,"success",1500)}catch(i){this._surfaceActionError(e.profileId,i,"copy the profile"),this._buttonFeedback.flash(t,"error")}}async _pasteRoutine(e){const t=`paste-${e.profileId}`;this._clearActionError(e.profileId);const i=await async function(){if(navigator.clipboard?.readText)try{const e=await navigator.clipboard.readText();if(e?.trim())return mt=e,e}catch{}return mt}();if(!i)return this._setActionError(e.profileId,"Nothing to paste — copy a profile first."),void this._buttonFeedback.flash(t,"error");const o=function(e){try{const t=JSON.parse(e);if((1===t?.version||2===t?.version)&&t?.type===ut&&t.rooms&&"object"==typeof t.rooms)return t}catch{}return null}(i);if(!o)return this._setActionError(e.profileId,"The clipboard doesn't contain profile settings."),void this._buttonFeedback.flash(t,"error");const s=function(e,t,i,o,s){let r=0;for(const e of t){const t=i.rooms[e.name];if(!t)continue;void 0!==t.fanOverride&&_e(e.fanOverride)&&(s(e.fanOverride,t.fanOverride),r++),void 0!==t.fanReverse&&_e(e.fanReverse)&&(s(e.fanReverse,t.fanReverse),r++);const n=[{key:"cooling",useId:e.useCooling,tempId:e.cooling,enabled:!0},{key:"heating",useId:e.useHeating,tempId:e.heating,enabled:!1!==e.has_heating},{key:"fan",useId:e.useFan,tempId:e.fan,enabled:!1!==e.has_fan}];for(const e of n){if(!e.enabled)continue;const i=vt("cooling"===e.key?t.cooling:"heating"===e.key?t.heating:t.fan);i&&(void 0!==i.use&&_e(e.useId)&&(s(e.useId,i.use),r++),void 0!==i.temp&&_e(e.tempId)&&(o(e.tempId,i.temp),r++))}}return r}(this.hass,[e.room],o,(e,t)=>be(this.hass,e,t),(e,t)=>function(e,t,i){const o=t.split(".")[0];e.callService(o,i?"turn_on":"turn_off",{entity_id:t})}(this.hass,e,t));if(0===s)return this._setActionError(e.profileId,"Nothing in the clipboard matched this room's devices."),void this._buttonFeedback.flash(t,"error");this._buttonFeedback.flash(t,"success")}async _copyCurrentRoom(){const e="copy-room";try{const t=await kt(this.hass,this.config,this.roomKey);t&&this._showAddForm&&(this._pasteRoomSettingsOnCreate=!0),this._buttonFeedback.flash(e,t?"success":"error",1500)}catch{this._buttonFeedback.flash(e,"error")}}_setActionError(e,t){this._actionError={...this._actionError,[e]:t}}_clearActionError(e){if(void 0===this._actionError[e])return;const t={...this._actionError};delete t[e],this._actionError=t}_surfaceActionError(e,t,i){this._setActionError(e,Fe(t)||`Could not ${i}. Check Settings → System → Logs.`)}async _applyNow(e){const t=`apply-${e.profileId}`;this._busy=!0,this._clearActionError(e.profileId);try{await(i=this.hass,o=e.profileId,i.callWS({type:"room_climate_controller/profiles/apply",profile_id:o})),this._buttonFeedback.flash(t,"success")}catch(i){this._surfaceActionError(e.profileId,i,"apply the profile"),this._buttonFeedback.flash(t,"error")}finally{this._busy=!1}var i,o}_renameValue(e){return void 0!==this._renameDrafts[e.profileId]?this._renameDrafts[e.profileId]:wt(e.name,e.profileId)}_savedProfileName(e){return wt(e.name,e.profileId)}async _commitProfileName(e,t){const i=t.trim(),o=this._savedProfileName(e),s=`name-${e.profileId}`;if(i===o){const t={...this._renameDrafts};return delete t[e.profileId],void(this._renameDrafts=t)}if(!i){const t={...this._renameDrafts};return delete t[e.profileId],this._renameDrafts=t,this._setActionError(e.profileId,"Enter a profile name."),void this._flashField(s,"error")}this._busy=!0,this._clearActionError(e.profileId);try{await function(e,t,i){return e.callWS({type:"room_climate_controller/profiles/rename",profile_id:t,name:i})}(this.hass,e.profileId,i);const t={...this._renameDrafts};delete t[e.profileId],this._renameDrafts=t,await je(this.hass),this._flashField(s,"success")}catch(t){this._surfaceActionError(e.profileId,t,"rename the profile"),this._flashField(s,"error")}finally{this._busy=!1}}async _setProfileTime(e,t){const i=`time-${e.profileId}`;if(this._clearActionError(e.profileId),St(this.hass,this.roomKey,e.profileId,t))return this._setActionError(e.profileId,this._timeConflictMessage(t,e.profileId)),void this._flashField(i,"error");var o,s,r;if(_e(e.time))try{await(o=this.hass,s=e.time,r=`${t}:00`,"input_datetime"===s.split(".")[0]?o.callService("input_datetime","set_datetime",{entity_id:s,time:r}):o.callService("time","set_value",{entity_id:s,time:r})),await je(this.hass),this._flashField(i,"success")}catch(t){this._surfaceActionError(e.profileId,t,"change the profile time"),this._flashField(i,"error")}}_timeConflictMessage(e,t=""){const i=St(this.hass,this.roomKey,t,e);if(!i)return"Another profile in this room already uses that time.";return`“${wt(i.name,i.profileId)}” already runs at ${e} in this room.`}async _addProfile(){const e="add-profile",t="add-profile-time",i=this._newProfileName.trim(),o=Ct(this._newProfileTime);if(this._addError="",!i)return this._addError="Enter a profile name.",void this._buttonFeedback.flash(e,"error");if(!o)return this._addError="Choose a valid time.",void this._flashField(t,"error");if(St(this.hass,this.roomKey,"",o))return this._addError=this._timeConflictMessage(o),void this._flashField(t,"error");this._busy=!0;try{const t=await(s=this.hass,r={name:i,room:this.roomKey,time:o,copy_room_settings:this._pasteRoomSettingsOnCreate},s.callWS({type:"room_climate_controller/profiles/create",...r}));await je(this.hass),this._pasteRoomSettingsOnCreate=!1;const n=t.profile?.id;n&&(this._openProfileIds=new Set([...this._openProfileIds,n])),this._newProfileName="",this._newProfileTime=Nt(this.hass,this.roomKey),this._showAddForm=!1,this._addError="",this._buttonFeedback.flash(e,"success")}catch(t){this._addError=Fe(t)||"Could not create profile. Check Settings → System → Logs.",this._buttonFeedback.flash(e,"error")}finally{this._busy=!1}var s,r}async _deleteProfile(e){const t=`delete-${e.profileId}`,i=wt(e.name,e.profileId);if(window.confirm(`Delete profile “${i}”?`)){this._busy=!0,this._clearActionError(e.profileId);try{await(o=this.hass,s=e.profileId,o.callWS({type:"room_climate_controller/profiles/delete",profile_id:s}));const i=new Set(this._openProfileIds);i.delete(e.profileId),this._openProfileIds=i,await je(this.hass),this._buttonFeedback.flash(t,"success",800)}catch(i){this._surfaceActionError(e.profileId,i,"delete the profile"),this._buttonFeedback.flash(t,"error")}finally{this._busy=!1}var o,s}}_renderProfile(e){const t=_e(e.time)?$e(this.hass.states[e.time]?.state):"",i=wt(e.name,e.profileId),o=function(e,t){const i=$e(e.states[t.time]?.state);return!!i&&Boolean(St(e,t.roomKey,t.profileId,i))}(this.hass,e),s=`time-${e.profileId}`,r=`name-${e.profileId}`;return L`
      <details
        class="profile-item"
      ...
      <div class="profiles-toolbar">
        ...
        ${this._showAddForm?L`
              ...
              <button
                ...
                ?disabled=${this._busy}
                @click=${()=>{this._showAddForm=!1,this._newProfileName="",this._newProfileTime=Nt(this.hass,this.roomKey),this._addError="",this._pasteRoomSettingsOnCreate=!1}}
              >
                <span>Cancel</span>
              </button>
            ...
            `:L`
              <button
                ...
                class="rcc-btn profile-action-btn"
                ?disabled=${this._busy}
                @click=${()=>{this._newProfileName="",this._newProfileTime=Nt(this.hass,this.roomKey),this._addError="",this._pasteRoomSettingsOnCreate=!1,this._showAddForm=!0,this._focusAddName=!0}}
              >
    ...
    `}render(){const e=this._routines(),t=e.filter(Et);return L`
      <details
